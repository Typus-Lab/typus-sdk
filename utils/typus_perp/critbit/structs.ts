...
export function isCritbitTree(type: string): boolean {
    ...
    return type.startsWith("0x6340d69ce680b0b740d20d7ab866678c0a331ad29795bafa138a5f4055dcc25c::critbit::CritbitTree<");
}
...
export class CritbitTree<V extends TypeArgument> implements StructClass {
    static readonly $typeName = "0x6340d69ce680b0b740d20d7ab866678c0a331ad29795bafa138a5f4055dcc25c::critbit::CritbitTree";
    static readonly $numTypeParams = 1;

    readonly $typeName = CritbitTree.$typeName;

    readonly $fullTypeName: `0x6340d69ce680b0b740d20d7ab866678c0a331ad29795bafa138a5f4055dcc25c::critbit::CritbitTree<${ToTypeStr<V>}>`;
    ...
    private constructor(typeArgs: [ToTypeStr<V>], fields: CritbitTreeFields<V>) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `0x6340d69ce680b0b740d20d7ab866678c0a331ad29795bafa138a5f4055dcc25c::critbit::CritbitTree<${ToTypeStr<V>}>`;
    ...
    static reified<V extends Reified<TypeArgument, any>>(V: V): CritbitTreeReified<ToTypeArgument<V>> {
        return {
            ...
            fullTypeName: composeSuiType(
                CritbitTree.$typeName,
                ...[extractType(V)]
            ) as `0x6340d69ce680b0b740d20d7ab866678c0a331ad29795bafa138a5f4055dcc25c::critbit::CritbitTree<${ToTypeStr<ToTypeArgument<V>>}>`,
...
export function isInternalNode(type: string): boolean {
    type = compressSuiType(type);
    return type === "0x6340d69ce680b0b740d20d7ab866678c0a331ad29795bafa138a5f4055dcc25c::critbit::InternalNode";
}
...
export class InternalNode implements StructClass {
    static readonly $typeName = "0x6340d69ce680b0b740d20d7ab866678c0a331ad29795bafa138a5f4055dcc25c::critbit::InternalNode";
    static readonly $numTypeParams = 0;

    readonly $typeName = InternalNode.$typeName;

    readonly $fullTypeName: "0x6340d69ce680b0b740d20d7ab866678c0a331ad29795bafa138a5f4055dcc25c::critbit::InternalNode";
    ...
    private constructor(typeArgs: [], fields: InternalNodeFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0x6340d69ce680b0b740d20d7ab866678c0a331ad29795bafa138a5f4055dcc25c::critbit::InternalNode";
        this.$typeArgs = typeArgs;
...
export function isLeaf(type: string): boolean {
    type = compressSuiType(type);
    return type.startsWith("0x6340d69ce680b0b740d20d7ab866678c0a331ad29795bafa138a5f4055dcc25c::critbit::Leaf<");
}
...
export class Leaf<V extends TypeArgument> implements StructClass {
    static readonly $typeName = "0x6340d69ce680b0b740d20d7ab866678c0a331ad29795bafa138a5f4055dcc25c::critbit::Leaf";
    static readonly $numTypeParams = 1;

    readonly $typeName = Leaf.$typeName;

    readonly $fullTypeName: `0x6340d69ce680b0b740d20d7ab866678c0a331ad29795bafa138a5f4055dcc25c::critbit::Leaf<${ToTypeStr<V>}>`;
    ...
    private constructor(typeArgs: [ToTypeStr<V>], fields: LeafFields<V>) {
        this.$fullTypeName = composeSuiType(
            Leaf.$typeName,
            ...typeArgs
        ) as `0x6340d69ce680b0b740d20d7ab866678c0a331ad29795bafa138a5f4055dcc25c::critbit::Leaf<${ToTypeStr<V>}>`;
        this.$typeArgs = typeArgs;
    ...
    static reified<V extends Reified<TypeArgument, any>>(V: V): LeafReified<ToTypeArgument<V>> {
        return {
            ...
            fullTypeName: composeSuiType(
                Leaf.$typeName,
                ...[extractType(V)]
            ) as `0x6340d69ce680b0b740d20d7ab866678c0a331ad29795bafa138a5f4055dcc25c::critbit::Leaf<${ToTypeStr<ToTypeArgument<V>>}>`,
            typeArgs: [extractType(V)] as [ToTypeStr<ToTypeArgument<V>>],
            reifiedTypeArgs: [V],
