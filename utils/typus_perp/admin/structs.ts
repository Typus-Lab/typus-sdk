...
export class Version implements StructClass {
    ...
    private constructor(typeArgs: [], fields: VersionFields) {
        this.$fullTypeName = composeSuiType(
            Version.$typeName,
            ...typeArgs
        ) as "0x4bcf9eade4480bcb9fcd3139ec8d22afda34b25af06092904fcccb06e1b8043c::admin::Version";
...
export class ManagerCap implements StructClass {
    ...
    private constructor(typeArgs: [], fields: ManagerCapFields) {
        this.$fullTypeName = composeSuiType(
            ManagerCap.$typeName,
            ...typeArgs
        ) as "0x4bcf9eade4480bcb9fcd3139ec8d22afda34b25af06092904fcccb06e1b8043c::admin::ManagerCap";
        this.$typeArgs = typeArgs;
...
export class FeeInfo implements StructClass {
    ...
    private constructor(typeArgs: [], fields: FeeInfoFields) {
        this.$fullTypeName = composeSuiType(
            FeeInfo.$typeName,
            ...typeArgs
        ) as "0x4bcf9eade4480bcb9fcd3139ec8d22afda34b25af06092904fcccb06e1b8043c::admin::FeeInfo";
        this.$typeArgs = typeArgs;
...
export class FeePool implements StructClass {
    ...
    private constructor(typeArgs: [], fields: FeePoolFields) {
        this.$fullTypeName = composeSuiType(
            FeePool.$typeName,
            ...typeArgs
        ) as "0x4bcf9eade4480bcb9fcd3139ec8d22afda34b25af06092904fcccb06e1b8043c::admin::FeePool";
        this.$typeArgs = typeArgs;
    ...
    toJSONField() {
        return {
            ...
            feeInfos: fieldToJSON<Vector<FeeInfo>>(
                `vector<0x4bcf9eade4480bcb9fcd3139ec8d22afda34b25af06092904fcccb06e1b8043c::admin::FeeInfo>`,
                this.feeInfos
            ),
        };
    }
...
export class SendFeeEvent implements StructClass {
    ...
    private constructor(typeArgs: [], fields: SendFeeEventFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0x4bcf9eade4480bcb9fcd3139ec8d22afda34b25af06092904fcccb06e1b8043c::admin::SendFeeEvent";
        this.$typeArgs = typeArgs;
