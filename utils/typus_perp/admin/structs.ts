...
export function isFeeInfo(type: string): boolean {
    ...
    return type === "0x1a05edb0e5e670196de98fbbf544180d129dd4ec11c3c57f742badf0304650d::admin::FeeInfo";
}
...
export class FeeInfo implements StructClass {
    static readonly $typeName = "0x1a05edb0e5e670196de98fbbf544180d129dd4ec11c3c57f742badf0304650d::admin::FeeInfo";
    static readonly $numTypeParams = 0;

    readonly $typeName = FeeInfo.$typeName;

    readonly $fullTypeName: "0x1a05edb0e5e670196de98fbbf544180d129dd4ec11c3c57f742badf0304650d::admin::FeeInfo";
    ...
    private constructor(typeArgs: [], fields: FeeInfoFields) {
        this.$fullTypeName = composeSuiType(
            FeeInfo.$typeName,
            ...typeArgs
        ) as "0x1a05edb0e5e670196de98fbbf544180d129dd4ec11c3c57f742badf0304650d::admin::FeeInfo";
...
export function isFeePool(type: string): boolean {
    type = compressSuiType(type);
    return type === "0x1a05edb0e5e670196de98fbbf544180d129dd4ec11c3c57f742badf0304650d::admin::FeePool";
}
...
export class FeePool implements StructClass {
    static readonly $typeName = "0x1a05edb0e5e670196de98fbbf544180d129dd4ec11c3c57f742badf0304650d::admin::FeePool";
    static readonly $numTypeParams = 0;

    readonly $typeName = FeePool.$typeName;

    readonly $fullTypeName: "0x1a05edb0e5e670196de98fbbf544180d129dd4ec11c3c57f742badf0304650d::admin::FeePool";
    ...
    private constructor(typeArgs: [], fields: FeePoolFields) {
        this.$fullTypeName = composeSuiType(
            FeePool.$typeName,
            ...typeArgs
        ) as "0x1a05edb0e5e670196de98fbbf544180d129dd4ec11c3c57f742badf0304650d::admin::FeePool";
        this.$typeArgs = typeArgs;
    ...
    toJSONField() {
        return {
            ...
            feeInfos: fieldToJSON<Vector<FeeInfo>>(
                `vector<0x1a05edb0e5e670196de98fbbf544180d129dd4ec11c3c57f742badf0304650d::admin::FeeInfo>`,
                this.feeInfos
            ),
        };
    }
...
export function isManagerCap(type: string): boolean {
    type = compressSuiType(type);
    return type === "0x1a05edb0e5e670196de98fbbf544180d129dd4ec11c3c57f742badf0304650d::admin::ManagerCap";
}
...
export class ManagerCap implements StructClass {
    static readonly $typeName = "0x1a05edb0e5e670196de98fbbf544180d129dd4ec11c3c57f742badf0304650d::admin::ManagerCap";
    static readonly $numTypeParams = 0;

    readonly $typeName = ManagerCap.$typeName;

    readonly $fullTypeName: "0x1a05edb0e5e670196de98fbbf544180d129dd4ec11c3c57f742badf0304650d::admin::ManagerCap";
    ...
    private constructor(typeArgs: [], fields: ManagerCapFields) {
        this.$fullTypeName = composeSuiType(
            ManagerCap.$typeName,
            ...typeArgs
        ) as "0x1a05edb0e5e670196de98fbbf544180d129dd4ec11c3c57f742badf0304650d::admin::ManagerCap";
        this.$typeArgs = typeArgs;
...
export function isSendFeeEvent(type: string): boolean {
    type = compressSuiType(type);
    return type === "0x1a05edb0e5e670196de98fbbf544180d129dd4ec11c3c57f742badf0304650d::admin::SendFeeEvent";
}
...
export class SendFeeEvent implements StructClass {
    static readonly $typeName = "0x1a05edb0e5e670196de98fbbf544180d129dd4ec11c3c57f742badf0304650d::admin::SendFeeEvent";
    static readonly $numTypeParams = 0;

    readonly $typeName = SendFeeEvent.$typeName;

    readonly $fullTypeName: "0x1a05edb0e5e670196de98fbbf544180d129dd4ec11c3c57f742badf0304650d::admin::SendFeeEvent";
    ...
    private constructor(typeArgs: [], fields: SendFeeEventFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0x1a05edb0e5e670196de98fbbf544180d129dd4ec11c3c57f742badf0304650d::admin::SendFeeEvent";
        this.$typeArgs = typeArgs;
...
export function isVersion(type: string): boolean {
    type = compressSuiType(type);
    return type === "0x1a05edb0e5e670196de98fbbf544180d129dd4ec11c3c57f742badf0304650d::admin::Version";
}
...
export class Version implements StructClass {
    static readonly $typeName = "0x1a05edb0e5e670196de98fbbf544180d129dd4ec11c3c57f742badf0304650d::admin::Version";
    static readonly $numTypeParams = 0;

    readonly $typeName = Version.$typeName;

    readonly $fullTypeName: "0x1a05edb0e5e670196de98fbbf544180d129dd4ec11c3c57f742badf0304650d::admin::Version";
    ...
    private constructor(typeArgs: [], fields: VersionFields) {
        this.$fullTypeName = composeSuiType(
            Version.$typeName,
            ...typeArgs
        ) as "0x1a05edb0e5e670196de98fbbf544180d129dd4ec11c3c57f742badf0304650d::admin::Version";
        this.$typeArgs = typeArgs;
