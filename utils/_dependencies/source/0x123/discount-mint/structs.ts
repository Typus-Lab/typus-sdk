...
export function isPool(type: string): boolean {
    ...
    return type === "0x123::discount_mint::Pool";
}
...
export class Pool implements StructClass {
    static readonly $typeName = "0x123::discount_mint::Pool";
    static readonly $numTypeParams = 0;

    readonly $typeName = Pool.$typeName;

    readonly $fullTypeName: "0x123::discount_mint::Pool";
    ...
    private constructor(typeArgs: [], fields: PoolFields) {
        this.$fullTypeName = composeSuiType(Pool.$typeName, ...typeArgs) as "0x123::discount_mint::Pool";
    ...
    static reified(): PoolReified {
        return {
            ...
            fullTypeName: composeSuiType(Pool.$typeName, ...[]) as "0x123::discount_mint::Pool",
            typeArgs: [] as [],
            reifiedTypeArgs: [],
    ...
    toJSONField() {
        return {
            ...
            requests: fieldToJSON<Vector<MintRequest>>(`vector<0x123::discount_mint::MintRequest>`, this.requests),
        };
    }
...
export function isDiscountEvent(type: string): boolean {
    type = compressSuiType(type);
    return type === "0x123::discount_mint::DiscountEvent";
}
...
export class DiscountEvent implements StructClass {
    static readonly $typeName = "0x123::discount_mint::DiscountEvent";
    static readonly $numTypeParams = 0;

    readonly $typeName = DiscountEvent.$typeName;

    readonly $fullTypeName: "0x123::discount_mint::DiscountEvent";
    ...
    private constructor(typeArgs: [], fields: DiscountEventFields) {
        this.$fullTypeName = composeSuiType(DiscountEvent.$typeName, ...typeArgs) as "0x123::discount_mint::DiscountEvent";
        this.$typeArgs = typeArgs;
    ...
    static reified(): DiscountEventReified {
        return {
            ...
            fullTypeName: composeSuiType(DiscountEvent.$typeName, ...[]) as "0x123::discount_mint::DiscountEvent",
            typeArgs: [] as [],
            reifiedTypeArgs: [],
...
export function isDiscountEventV2(type: string): boolean {
    type = compressSuiType(type);
    return type === "0x123::discount_mint::DiscountEventV2";
}
...
export class DiscountEventV2 implements StructClass {
    static readonly $typeName = "0x123::discount_mint::DiscountEventV2";
    static readonly $numTypeParams = 0;

    readonly $typeName = DiscountEventV2.$typeName;

    readonly $fullTypeName: "0x123::discount_mint::DiscountEventV2";
    ...
    private constructor(typeArgs: [], fields: DiscountEventV2Fields) {
        this.$fullTypeName = composeSuiType(DiscountEventV2.$typeName, ...typeArgs) as "0x123::discount_mint::DiscountEventV2";
        this.$typeArgs = typeArgs;
    ...
    static reified(): DiscountEventV2Reified {
        return {
            ...
            fullTypeName: composeSuiType(DiscountEventV2.$typeName, ...[]) as "0x123::discount_mint::DiscountEventV2",
            typeArgs: [] as [],
            reifiedTypeArgs: [],
...
export function isDiscountEventV3(type: string): boolean {
    type = compressSuiType(type);
    return type === "0x123::discount_mint::DiscountEventV3";
}
...
export class DiscountEventV3 implements StructClass {
    static readonly $typeName = "0x123::discount_mint::DiscountEventV3";
    static readonly $numTypeParams = 0;

    readonly $typeName = DiscountEventV3.$typeName;

    readonly $fullTypeName: "0x123::discount_mint::DiscountEventV3";
    ...
    private constructor(typeArgs: [], fields: DiscountEventV3Fields) {
        this.$fullTypeName = composeSuiType(DiscountEventV3.$typeName, ...typeArgs) as "0x123::discount_mint::DiscountEventV3";
        this.$typeArgs = typeArgs;
    ...
    static reified(): DiscountEventV3Reified {
        return {
            ...
            fullTypeName: composeSuiType(DiscountEventV3.$typeName, ...[]) as "0x123::discount_mint::DiscountEventV3",
            typeArgs: [] as [],
            reifiedTypeArgs: [],
...
export function isMintRequest(type: string): boolean {
    type = compressSuiType(type);
    return type === "0x123::discount_mint::MintRequest";
}
...
export class MintRequest implements StructClass {
    static readonly $typeName = "0x123::discount_mint::MintRequest";
    static readonly $numTypeParams = 0;

    readonly $typeName = MintRequest.$typeName;

    readonly $fullTypeName: "0x123::discount_mint::MintRequest";
    ...
    private constructor(typeArgs: [], fields: MintRequestFields) {
        this.$fullTypeName = composeSuiType(MintRequest.$typeName, ...typeArgs) as "0x123::discount_mint::MintRequest";
        this.$typeArgs = typeArgs;
    ...
    static reified(): MintRequestReified {
        return {
            ...
            fullTypeName: composeSuiType(MintRequest.$typeName, ...[]) as "0x123::discount_mint::MintRequest",
            typeArgs: [] as [],
            reifiedTypeArgs: [],
...
export function isMintRequestEvent(type: string): boolean {
    type = compressSuiType(type);
    return type === "0x123::discount_mint::MintRequestEvent";
}
...
export class MintRequestEvent implements StructClass {
    static readonly $typeName = "0x123::discount_mint::MintRequestEvent";
    static readonly $numTypeParams = 0;

    readonly $typeName = MintRequestEvent.$typeName;

    readonly $fullTypeName: "0x123::discount_mint::MintRequestEvent";
    ...
    private constructor(typeArgs: [], fields: MintRequestEventFields) {
        this.$fullTypeName = composeSuiType(MintRequestEvent.$typeName, ...typeArgs) as "0x123::discount_mint::MintRequestEvent";
        this.$typeArgs = typeArgs;
    ...
    static reified(): MintRequestEventReified {
        return {
            ...
            fullTypeName: composeSuiType(MintRequestEvent.$typeName, ...[]) as "0x123::discount_mint::MintRequestEvent",
            typeArgs: [] as [],
            reifiedTypeArgs: [],
