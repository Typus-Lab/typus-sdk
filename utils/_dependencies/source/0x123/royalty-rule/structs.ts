...
export function isConfig(type: string): boolean {
    ...
    return type === "0x123::royalty_rule::Config";
}
...
export class Config implements StructClass {
    static readonly $typeName = "0x123::royalty_rule::Config";
    static readonly $numTypeParams = 0;

    readonly $typeName = Config.$typeName;

    readonly $fullTypeName: "0x123::royalty_rule::Config";
    ...
    private constructor(typeArgs: [], fields: ConfigFields) {
        this.$fullTypeName = composeSuiType(Config.$typeName, ...typeArgs) as "0x123::royalty_rule::Config";
    ...
    static reified(): ConfigReified {
        return {
            ...
            fullTypeName: composeSuiType(Config.$typeName, ...[]) as "0x123::royalty_rule::Config",
            typeArgs: [] as [],
            reifiedTypeArgs: [],
...
export function isRule(type: string): boolean {
    type = compressSuiType(type);
    return type === "0x123::royalty_rule::Rule";
}
...
export class Rule implements StructClass {
    static readonly $typeName = "0x123::royalty_rule::Rule";
    static readonly $numTypeParams = 0;

    readonly $typeName = Rule.$typeName;

    readonly $fullTypeName: "0x123::royalty_rule::Rule";
    ...
    private constructor(typeArgs: [], fields: RuleFields) {
        this.$fullTypeName = composeSuiType(Rule.$typeName, ...typeArgs) as "0x123::royalty_rule::Rule";
        this.$typeArgs = typeArgs;
    ...
    static reified(): RuleReified {
        return {
            ...
            fullTypeName: composeSuiType(Rule.$typeName, ...[]) as "0x123::royalty_rule::Rule",
            typeArgs: [] as [],
            reifiedTypeArgs: [],
