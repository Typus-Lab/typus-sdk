...
export class AddAuthorutyEvent implements StructClass {
    ...
    private constructor(typeArgs: [], fields: AddAuthorutyEventFields) {
        this.$fullTypeName = composeSuiType(
            AddAuthorutyEvent.$typeName,
            ...typeArgs
        ) as "0x6cddbfa30141e0332f8995a12453fc2cb07a2fa3dad52b342493780c7784f455::auto_bid::AddAuthorutyEvent";
    ...
    static get bcs() {
        return bcs.struct("AddAuthorutyEvent", {
            new_authority: bcs.bytes(32).transform({ input: (val: string) => fromHEX(val), output: (val: Uint8Array) => toHEX(val) }),
...
export class AutoBidEvent implements StructClass {
    ...
    private constructor(typeArgs: [], fields: AutoBidEventFields) {
        this.$fullTypeName = composeSuiType(
            AutoBidEvent.$typeName,
            ...typeArgs
        ) as "0x6cddbfa30141e0332f8995a12453fc2cb07a2fa3dad52b342493780c7784f455::auto_bid::AutoBidEvent";
        this.$typeArgs = typeArgs;
    ...
    static fromFields(fields: Record<string, any>): AutoBidEvent {
        return AutoBidEvent.reified().new({ dummyField: decodeFromFields("bool", fields.dummy_field) });
    }
    ...
    static fromJSONField(field: any): AutoBidEvent {
        return AutoBidEvent.reified().new({ dummyField: decodeFromJSONField("bool", field.dummyField) });
    }
...
export class CloseStrategyEvent implements StructClass {
    ...
    private constructor(typeArgs: [], fields: CloseStrategyEventFields) {
        this.$fullTypeName = composeSuiType(
            CloseStrategyEvent.$typeName,
            ...typeArgs
        ) as "0x6cddbfa30141e0332f8995a12453fc2cb07a2fa3dad52b342493780c7784f455::auto_bid::CloseStrategyEvent";
        this.$typeArgs = typeArgs;
...
export class CloseStrategyEventV2 implements StructClass {
    ...
    private constructor(typeArgs: [], fields: CloseStrategyEventV2Fields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0x6cddbfa30141e0332f8995a12453fc2cb07a2fa3dad52b342493780c7784f455::auto_bid::CloseStrategyEventV2";
        this.$typeArgs = typeArgs;
...
export class NewStrategyEvent implements StructClass {
    ...
    private constructor(typeArgs: [], fields: NewStrategyEventFields) {
        this.$fullTypeName = composeSuiType(
            NewStrategyEvent.$typeName,
            ...typeArgs
        ) as "0x6cddbfa30141e0332f8995a12453fc2cb07a2fa3dad52b342493780c7784f455::auto_bid::NewStrategyEvent";
        this.$typeArgs = typeArgs;
...
export class NewStrategyEventV2 implements StructClass {
    ...
    private constructor(typeArgs: [], fields: NewStrategyEventV2Fields) {
        this.$fullTypeName = composeSuiType(
            NewStrategyEventV2.$typeName,
            ...typeArgs
        ) as "0x6cddbfa30141e0332f8995a12453fc2cb07a2fa3dad52b342493780c7784f455::auto_bid::NewStrategyEventV2";
        this.$typeArgs = typeArgs;
...
export class NewStrategyPoolEvent implements StructClass {
    ...
    private constructor(typeArgs: [], fields: NewStrategyPoolEventFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0x6cddbfa30141e0332f8995a12453fc2cb07a2fa3dad52b342493780c7784f455::auto_bid::NewStrategyPoolEvent";
        this.$typeArgs = typeArgs;
...
export class NewStrategySignalEvent implements StructClass {
    ...
    private constructor(typeArgs: [], fields: NewStrategySignalEventFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0x6cddbfa30141e0332f8995a12453fc2cb07a2fa3dad52b342493780c7784f455::auto_bid::NewStrategySignalEvent";
        this.$typeArgs = typeArgs;
...
export class NewStrategyVaultEvent implements StructClass {
    ...
    private constructor(typeArgs: [], fields: NewStrategyVaultEventFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0x6cddbfa30141e0332f8995a12453fc2cb07a2fa3dad52b342493780c7784f455::auto_bid::NewStrategyVaultEvent";
        this.$typeArgs = typeArgs;
...
export class Strategy implements StructClass {
    ...
    private constructor(typeArgs: [], fields: StrategyFields) {
        this.$fullTypeName = composeSuiType(
            Strategy.$typeName,
            ...typeArgs
        ) as "0x6cddbfa30141e0332f8995a12453fc2cb07a2fa3dad52b342493780c7784f455::auto_bid::Strategy";
        this.$typeArgs = typeArgs;
    ...
    toJSONField() {
        return {
            ...
            maxTimes: this.maxTimes.toString(),
            targetRounds: fieldToJSON<Vector<"u64">>(`vector<u64>`, this.targetRounds),
            receipts: fieldToJSON<Vector<TypusBidReceipt>>(
                `vector<0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::TypusBidReceipt>`,
                this.receipts
            ),
            active: this.active,
            u64Padding: fieldToJSON<Vector<"u64">>(`vector<u64>`, this.u64Padding),
...
export class StrategyPool implements StructClass {
    ...
    private constructor(typeArgs: [], fields: StrategyPoolFields) {
        this.$fullTypeName = composeSuiType(
            StrategyPool.$typeName,
            ...typeArgs
        ) as "0x6cddbfa30141e0332f8995a12453fc2cb07a2fa3dad52b342493780c7784f455::auto_bid::StrategyPool";
        this.$typeArgs = typeArgs;
...
export class StrategyPoolV2 implements StructClass {
    ...
    private constructor(typeArgs: [], fields: StrategyPoolV2Fields) {
        this.$fullTypeName = composeSuiType(
            StrategyPoolV2.$typeName,
            ...typeArgs
        ) as "0x6cddbfa30141e0332f8995a12453fc2cb07a2fa3dad52b342493780c7784f455::auto_bid::StrategyPoolV2";
        this.$typeArgs = typeArgs;
...
export class StrategyV2 implements StructClass {
    ...
    private constructor(typeArgs: [], fields: StrategyV2Fields) {
        this.$fullTypeName = composeSuiType(
            StrategyV2.$typeName,
            ...typeArgs
        ) as "0x6cddbfa30141e0332f8995a12453fc2cb07a2fa3dad52b342493780c7784f455::auto_bid::StrategyV2";
        this.$typeArgs = typeArgs;
...
export class UpdateStrategyEvent implements StructClass {
    ...
    private constructor(typeArgs: [], fields: UpdateStrategyEventFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0x6cddbfa30141e0332f8995a12453fc2cb07a2fa3dad52b342493780c7784f455::auto_bid::UpdateStrategyEvent";
        this.$typeArgs = typeArgs;
...
export class WithdrawProfitEvent implements StructClass {
    ...
    private constructor(typeArgs: [], fields: WithdrawProfitEventFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0x6cddbfa30141e0332f8995a12453fc2cb07a2fa3dad52b342493780c7784f455::auto_bid::WithdrawProfitEvent";
        this.$typeArgs = typeArgs;
