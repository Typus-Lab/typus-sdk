...
export class Witness<T extends PhantomTypeArgument> implements StructClass {
    ...
    private constructor(typeArgs: [PhantomToTypeStr<T>], fields: WitnessFields<T>) {
        this.$fullTypeName = composeSuiType(
            Witness.$typeName,
            ...typeArgs
        ) as `0x779b5c547976899f5474f3a5bc0db36ddf4697ad7e5a901db0415c2281d28162::witness::Witness<${PhantomToTypeStr<T>}>`;
    ...
    static reified<T extends PhantomReified<PhantomTypeArgument>>(T: T): WitnessReified<ToPhantomTypeArgument<T>> {
        return {
            ...
            fullTypeName: composeSuiType(
                Witness.$typeName,
                ...[extractType(T)]
            ) as `0x779b5c547976899f5474f3a5bc0db36ddf4697ad7e5a901db0415c2281d28162::witness::Witness<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
            ...
            fromBcs: (data: Uint8Array) => Witness.fromBcs(T, data),
            bcs: Witness.bcs,
            ...
            fetch: async (client: SuiClient, id: string) => Witness.fetch(client, T, id),
    ...
    static fromFields<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return Witness.reified(typeArg).new({ dummyField: decodeFromFields("bool", fields.dummy_field) });
    }
    ...
    static fromJSONField<T extends PhantomReified<PhantomTypeArgument>>(typeArg: T, field: any): Witness<ToPhantomTypeArgument<T>> {
        return Witness.reified(typeArg).new({ dummyField: decodeFromJSONField("bool", field.dummyField) });
    }
    ...
    static fromJSON<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        assertReifiedTypeArgsMatch(composeSuiType(Witness.$typeName, extractType(typeArg)), json.$typeArgs, [typeArg]);
...
export class WitnessGenerator<T extends PhantomTypeArgument> implements StructClass {
    ...
    private constructor(typeArgs: [PhantomToTypeStr<T>], fields: WitnessGeneratorFields<T>) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `0x779b5c547976899f5474f3a5bc0db36ddf4697ad7e5a901db0415c2281d28162::witness::WitnessGenerator<${PhantomToTypeStr<T>}>`;
        this.$typeArgs = typeArgs;
    ...
    static reified<T extends PhantomReified<PhantomTypeArgument>>(T: T): WitnessGeneratorReified<ToPhantomTypeArgument<T>> {
        return {
            ...
            fullTypeName: composeSuiType(
                WitnessGenerator.$typeName,
                ...[extractType(T)]
            ) as `0x779b5c547976899f5474f3a5bc0db36ddf4697ad7e5a901db0415c2281d28162::witness::WitnessGenerator<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
            typeArgs: [extractType(T)] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>],
            reifiedTypeArgs: [T],
            ...
            fromBcs: (data: Uint8Array) => WitnessGenerator.fromBcs(T, data),
            ...
            fetch: async (client: SuiClient, id: string) => WitnessGenerator.fetch(client, T, id),
    ...
    static fromFields<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return WitnessGenerator.reified(typeArg).new({ dummyField: decodeFromFields("bool", fields.dummy_field) });
    }
    ...
    static fromJSONField<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return WitnessGenerator.reified(typeArg).new({ dummyField: decodeFromJSONField("bool", field.dummyField) });
    }
    ...
    static fromJSON<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        assertReifiedTypeArgsMatch(composeSuiType(WitnessGenerator.$typeName, extractType(typeArg)), json.$typeArgs, [typeArg]);
