...
export function isAirdrop(type: string): boolean {
    ...
    return type === "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::airdrop::Airdrop";
}
...
export class Airdrop implements StructClass {
    static readonly $typeName = "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::airdrop::Airdrop";
    static readonly $numTypeParams = 0;

    readonly $typeName = Airdrop.$typeName;

    readonly $fullTypeName: "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::airdrop::Airdrop";
    ...
    private constructor(typeArgs: [], fields: AirdropFields) {
        this.$fullTypeName = composeSuiType(
            Airdrop.$typeName,
            ...typeArgs
        ) as "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::airdrop::Airdrop";
...
export function isAirdropInfo(type: string): boolean {
    type = compressSuiType(type);
    return type.startsWith("0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::airdrop::AirdropInfo<");
}
...
export class AirdropInfo<TOKEN extends PhantomTypeArgument> implements StructClass {
    static readonly $typeName = "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::airdrop::AirdropInfo";
    static readonly $numTypeParams = 1;

    readonly $typeName = AirdropInfo.$typeName;

    readonly $fullTypeName: `0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::airdrop::AirdropInfo<${PhantomToTypeStr<TOKEN>}>`;
    ...
    private constructor(typeArgs: [PhantomToTypeStr<TOKEN>], fields: AirdropInfoFields<TOKEN>) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::airdrop::AirdropInfo<${PhantomToTypeStr<TOKEN>}>`;
        this.$typeArgs = typeArgs;
    ...
    static reified<TOKEN extends PhantomReified<PhantomTypeArgument>>(TOKEN: TOKEN): AirdropInfoReified<ToPhantomTypeArgument<TOKEN>> {
        return {
            ...
            fullTypeName: composeSuiType(
                AirdropInfo.$typeName,
                ...[extractType(TOKEN)]
            ) as `0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::airdrop::AirdropInfo<${PhantomToTypeStr<ToPhantomTypeArgument<TOKEN>>}>`,
...
export function isClaimAirdropEvent(type: string): boolean {
    type = compressSuiType(type);
    return type === "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::airdrop::ClaimAirdropEvent";
}
...
export class ClaimAirdropEvent implements StructClass {
    static readonly $typeName = "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::airdrop::ClaimAirdropEvent";
    static readonly $numTypeParams = 0;

    readonly $typeName = ClaimAirdropEvent.$typeName;

    readonly $fullTypeName: "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::airdrop::ClaimAirdropEvent";
    ...
    private constructor(typeArgs: [], fields: ClaimAirdropEventFields) {
        this.$fullTypeName = composeSuiType(
            ClaimAirdropEvent.$typeName,
            ...typeArgs
        ) as "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::airdrop::ClaimAirdropEvent";
        this.$typeArgs = typeArgs;
...
export function isRemoveAirdropEvent(type: string): boolean {
    type = compressSuiType(type);
    return type === "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::airdrop::RemoveAirdropEvent";
}
...
export class RemoveAirdropEvent implements StructClass {
    static readonly $typeName = "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::airdrop::RemoveAirdropEvent";
    static readonly $numTypeParams = 0;

    readonly $typeName = RemoveAirdropEvent.$typeName;

    readonly $fullTypeName: "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::airdrop::RemoveAirdropEvent";
    ...
    private constructor(typeArgs: [], fields: RemoveAirdropEventFields) {
        this.$fullTypeName = composeSuiType(
            RemoveAirdropEvent.$typeName,
            ...typeArgs
        ) as "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::airdrop::RemoveAirdropEvent";
        this.$typeArgs = typeArgs;
...
export function isSetAirdropEvent(type: string): boolean {
    type = compressSuiType(type);
    return type === "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::airdrop::SetAirdropEvent";
}
...
export class SetAirdropEvent implements StructClass {
    static readonly $typeName = "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::airdrop::SetAirdropEvent";
    static readonly $numTypeParams = 0;

    readonly $typeName = SetAirdropEvent.$typeName;

    readonly $fullTypeName: "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::airdrop::SetAirdropEvent";
    ...
    private constructor(typeArgs: [], fields: SetAirdropEventFields) {
        this.$fullTypeName = composeSuiType(
            SetAirdropEvent.$typeName,
            ...typeArgs
        ) as "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::airdrop::SetAirdropEvent";
        this.$typeArgs = typeArgs;
...
export function isTypusAirdropRegistry(type: string): boolean {
    type = compressSuiType(type);
    return type === "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::airdrop::TypusAirdropRegistry";
}
...
export class TypusAirdropRegistry implements StructClass {
    static readonly $typeName = "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::airdrop::TypusAirdropRegistry";
    static readonly $numTypeParams = 0;

    readonly $typeName = TypusAirdropRegistry.$typeName;

    readonly $fullTypeName: "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::airdrop::TypusAirdropRegistry";
    ...
    private constructor(typeArgs: [], fields: TypusAirdropRegistryFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::airdrop::TypusAirdropRegistry";
        this.$typeArgs = typeArgs;
