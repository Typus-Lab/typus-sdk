...
export function isI64(type: string): boolean {
    ...
    return type === "0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::i64::I64";
}
...
export class I64 implements StructClass {
    static readonly $typeName = "0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::i64::I64";
    static readonly $numTypeParams = 0;

    readonly $typeName = I64.$typeName;

    readonly $fullTypeName: "0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::i64::I64";
    ...
    private constructor(typeArgs: [], fields: I64Fields) {
        this.$fullTypeName = composeSuiType(
            I64.$typeName,
            ...typeArgs
        ) as "0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::i64::I64";
