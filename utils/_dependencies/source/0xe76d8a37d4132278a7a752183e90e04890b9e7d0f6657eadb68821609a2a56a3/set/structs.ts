...
export function isSet(type: string): boolean {
    ...
    return type.startsWith("0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::set::Set<");
}
...
export class Set<A extends TypeArgument> implements StructClass {
    ...
    private constructor(typeArgs: [ToTypeStr<A>], fields: SetFields<A>) {
        this.$fullTypeName = composeSuiType(
            Set.$typeName,
            ...typeArgs
        ) as `0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::set::Set<${ToTypeStr<A>}>`;
    ...
    static reified<A extends Reified<TypeArgument, any>>(A: A): SetReified<ToTypeArgument<A>> {
        return {
            ...
            fullTypeName: composeSuiType(
                Set.$typeName,
                ...[extractType(A)]
            ) as `0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::set::Set<${ToTypeStr<ToTypeArgument<A>>}>`,
    ...
    static fromFields<A extends Reified<TypeArgument, any>>(typeArg: A, fields: Record<string, any>): Set<ToTypeArgument<A>> {
        return Set.reified(typeArg).new({
            ...
            elems: decodeFromFields(Table.reified(reified.phantom(typeArg), reified.phantom(Unit.reified())), fields.elems),
        });
    }
    ...
    static fromFieldsWithTypes<A extends Reified<TypeArgument, any>>(typeArg: A, item: FieldsWithTypes): Set<ToTypeArgument<A>> {
        ...
        return Set.reified(typeArg).new({
            ...
            elems: decodeFromFieldsWithTypes(Table.reified(reified.phantom(typeArg), reified.phantom(Unit.reified())), item.fields.elems),
        });
    }
    ...
    static fromJSONField<A extends Reified<TypeArgument, any>>(typeArg: A, field: any): Set<ToTypeArgument<A>> {
        return Set.reified(typeArg).new({
            ...
            elems: decodeFromJSONField(Table.reified(reified.phantom(typeArg), reified.phantom(Unit.reified())), field.elems),
        });
    }
    ...
    static async fetch<A extends Reified<TypeArgument, any>>(client: SuiClient, typeArg: A, id: string): Promise<Set<ToTypeArgument<A>>> {
...
export function isUnit(type: string): boolean {
    type = compressSuiType(type);
    return type === "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::set::Unit";
}
...
export class Unit implements StructClass {
    ...
    private constructor(typeArgs: [], fields: UnitFields) {
        this.$fullTypeName = composeSuiType(
            Unit.$typeName,
            ...typeArgs
        ) as "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::set::Unit";
        this.$typeArgs = typeArgs;
