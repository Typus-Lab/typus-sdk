...
export function isI64(type: string): boolean {
    ...
    return type === "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::i64::I64";
}
...
export class I64 implements StructClass {
    ...
    private constructor(typeArgs: [], fields: I64Fields) {
        this.$fullTypeName = composeSuiType(
            I64.$typeName,
            ...typeArgs
        ) as "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::i64::I64";
