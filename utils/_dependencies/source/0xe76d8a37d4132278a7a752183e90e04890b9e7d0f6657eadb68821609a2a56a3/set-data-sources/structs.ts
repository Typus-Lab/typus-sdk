...
export function isDataSources(type: string): boolean {
    ...
    return type === "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::set_data_sources::DataSources";
}
...
export class DataSources implements StructClass {
    ...
    private constructor(typeArgs: [], fields: DataSourcesFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::set_data_sources::DataSources";
    ...
    toJSONField() {
        return {
            sources: fieldToJSON<Vector<DataSource>>(
                `vector<0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::data_source::DataSource>`,
                this.sources
            ),
        };
    }
