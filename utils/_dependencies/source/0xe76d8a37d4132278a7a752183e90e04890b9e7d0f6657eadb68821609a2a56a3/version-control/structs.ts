...
export function isV__0_1_1(type: string): boolean {
    ...
    return type === "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::version_control::V__0_1_1";
}
...
export class V__0_1_1 implements StructClass {
    ...
    private constructor(typeArgs: [], fields: V__0_1_1Fields) {
        this.$fullTypeName = composeSuiType(
            V__0_1_1.$typeName,
            ...typeArgs
        ) as "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::version_control::V__0_1_1";
...
export function isV__DUMMY(type: string): boolean {
    type = compressSuiType(type);
    return type === "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::version_control::V__DUMMY";
}
...
export class V__DUMMY implements StructClass {
    ...
    private constructor(typeArgs: [], fields: V__DUMMYFields) {
        this.$fullTypeName = composeSuiType(
            V__DUMMY.$typeName,
            ...typeArgs
        ) as "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::version_control::V__DUMMY";
        this.$typeArgs = typeArgs;
