...
export function isPriceFeedUpdateEvent(type: string): boolean {
    ...
    return type === "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::event::PriceFeedUpdateEvent";
}
...
export class PriceFeedUpdateEvent implements StructClass {
    ...
    private constructor(typeArgs: [], fields: PriceFeedUpdateEventFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::event::PriceFeedUpdateEvent";
...
export function isPythInitializationEvent(type: string): boolean {
    type = compressSuiType(type);
    return type === "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::event::PythInitializationEvent";
}
...
export class PythInitializationEvent implements StructClass {
    ...
    private constructor(typeArgs: [], fields: PythInitializationEventFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::event::PythInitializationEvent";
        this.$typeArgs = typeArgs;
