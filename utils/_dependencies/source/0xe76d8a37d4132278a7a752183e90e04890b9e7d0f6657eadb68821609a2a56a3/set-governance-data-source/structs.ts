...
export function isGovernanceDataSource(type: string): boolean {
    ...
    return type === "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::set_governance_data_source::GovernanceDataSource";
}
...
export class GovernanceDataSource implements StructClass {
    static readonly $typeName =
        "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::set_governance_data_source::GovernanceDataSource";
    ...
    private constructor(typeArgs: [], fields: GovernanceDataSourceFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::set_governance_data_source::GovernanceDataSource";
    ...
    static reified(): GovernanceDataSourceReified {
        return {
            ...
            fromFieldsWithTypes: (item: FieldsWithTypes) => GovernanceDataSource.fromFieldsWithTypes(item),
            ...
            fromSuiParsedData: (content: SuiParsedData) => GovernanceDataSource.fromSuiParsedData(content),
    ...
    static fromSuiParsedData(content: SuiParsedData): GovernanceDataSource {
        ...
        if (!isGovernanceDataSource(content.type)) {
            throw new Error(`object at ${(content.fields as any).id} is not a GovernanceDataSource object`);
        }
