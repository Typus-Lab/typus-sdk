...
export function isHotPotatoVector(type: string): boolean {
    ...
    return type.startsWith("0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::hot_potato_vector::HotPotatoVector<");
}
...
export class HotPotatoVector<T extends TypeArgument> implements StructClass {
    ...
    private constructor(typeArgs: [ToTypeStr<T>], fields: HotPotatoVectorFields<T>) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::hot_potato_vector::HotPotatoVector<${ToTypeStr<T>}>`;
    ...
    static reified<T extends Reified<TypeArgument, any>>(T: T): HotPotatoVectorReified<ToTypeArgument<T>> {
        return {
            ...
            fullTypeName: composeSuiType(
                HotPotatoVector.$typeName,
                ...[extractType(T)]
            ) as `0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::hot_potato_vector::HotPotatoVector<${ToTypeStr<ToTypeArgument<T>>}>`,
    ...
    static fromJSON<T extends Reified<TypeArgument, any>>(typeArg: T, json: Record<string, any>): HotPotatoVector<ToTypeArgument<T>> {
        ...
        assertReifiedTypeArgsMatch(composeSuiType(HotPotatoVector.$typeName, extractType(typeArg)), json.$typeArgs, [typeArg]);
