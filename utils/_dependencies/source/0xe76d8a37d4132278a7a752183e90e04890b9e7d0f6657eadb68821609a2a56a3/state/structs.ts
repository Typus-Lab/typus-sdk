...
export function isCurrentDigest(type: string): boolean {
    ...
    return type === "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::state::CurrentDigest";
}
...
export class CurrentDigest implements StructClass {
    ...
    private constructor(typeArgs: [], fields: CurrentDigestFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::state::CurrentDigest";
...
export function isLatestOnly(type: string): boolean {
    type = compressSuiType(type);
    return type === "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::state::LatestOnly";
}
...
export class LatestOnly implements StructClass {
    ...
    private constructor(typeArgs: [], fields: LatestOnlyFields) {
        this.$fullTypeName = composeSuiType(
            LatestOnly.$typeName,
            ...typeArgs
        ) as "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::state::LatestOnly";
        this.$typeArgs = typeArgs;
...
export function isState(type: string): boolean {
    type = compressSuiType(type);
    return type === "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::state::State";
}
...
export class State implements StructClass {
    ...
    private constructor(typeArgs: [], fields: StateFields) {
        this.$fullTypeName = composeSuiType(
            State.$typeName,
            ...typeArgs
        ) as "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::state::State";
        this.$typeArgs = typeArgs;
