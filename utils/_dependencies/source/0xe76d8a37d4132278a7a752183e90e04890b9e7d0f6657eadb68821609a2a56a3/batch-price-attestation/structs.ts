...
export function isBatchPriceAttestation(type: string): boolean {
    ...
    return type === "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::batch_price_attestation::BatchPriceAttestation";
}
...
export class BatchPriceAttestation implements StructClass {
    static readonly $typeName =
        "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::batch_price_attestation::BatchPriceAttestation";
    ...
    private constructor(typeArgs: [], fields: BatchPriceAttestationFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::batch_price_attestation::BatchPriceAttestation";
    ...
    static reified(): BatchPriceAttestationReified {
        return {
            ...
            fromFieldsWithTypes: (item: FieldsWithTypes) => BatchPriceAttestation.fromFieldsWithTypes(item),
            ...
            fromSuiParsedData: (content: SuiParsedData) => BatchPriceAttestation.fromSuiParsedData(content),
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): BatchPriceAttestation {
        ...
        return BatchPriceAttestation.reified().new({
            ...
            priceInfos: decodeFromFieldsWithTypes(reified.vector(PriceInfo.reified()), item.fields.price_infos),
        });
    }
    ...
    toJSONField() {
        return {
            ...
            priceInfos: fieldToJSON<Vector<PriceInfo>>(
                `vector<0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::price_info::PriceInfo>`,
                this.priceInfos
            ),
        };
    }
    ...
    static fromSuiParsedData(content: SuiParsedData): BatchPriceAttestation {
        ...
        if (!isBatchPriceAttestation(content.type)) {
            throw new Error(`object at ${(content.fields as any).id} is not a BatchPriceAttestation object`);
        }
...
export function isHeader(type: string): boolean {
    type = compressSuiType(type);
    return type === "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::batch_price_attestation::Header";
}
...
export class Header implements StructClass {
    ...
    private constructor(typeArgs: [], fields: HeaderFields) {
        this.$fullTypeName = composeSuiType(
            Header.$typeName,
            ...typeArgs
        ) as "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::batch_price_attestation::Header";
        this.$typeArgs = typeArgs;
