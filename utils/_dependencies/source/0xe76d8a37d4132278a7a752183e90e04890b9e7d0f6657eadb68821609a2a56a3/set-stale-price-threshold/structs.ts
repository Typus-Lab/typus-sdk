...
export function isStalePriceThreshold(type: string): boolean {
    ...
    return type === "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::set_stale_price_threshold::StalePriceThreshold";
}
...
export class StalePriceThreshold implements StructClass {
    static readonly $typeName =
        "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::set_stale_price_threshold::StalePriceThreshold";
    ...
    private constructor(typeArgs: [], fields: StalePriceThresholdFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::set_stale_price_threshold::StalePriceThreshold";
