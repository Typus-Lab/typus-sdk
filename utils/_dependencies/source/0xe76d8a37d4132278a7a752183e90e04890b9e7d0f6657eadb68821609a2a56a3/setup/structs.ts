...
export function isDeployerCap(type: string): boolean {
    ...
    return type === "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::setup::DeployerCap";
}
...
export class DeployerCap implements StructClass {
    ...
    private constructor(typeArgs: [], fields: DeployerCapFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::setup::DeployerCap";
