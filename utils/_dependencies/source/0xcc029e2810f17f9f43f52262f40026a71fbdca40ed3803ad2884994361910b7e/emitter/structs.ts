...
export function isEmitterCap(type: string): boolean {
    ...
    return type === "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::emitter::EmitterCap";
}
...
export class EmitterCap implements StructClass {
    ...
    private constructor(typeArgs: [], fields: EmitterCapFields) {
        this.$fullTypeName = composeSuiType(
            EmitterCap.$typeName,
            ...typeArgs
        ) as "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::emitter::EmitterCap";
...
export function isEmitterCreated(type: string): boolean {
    type = compressSuiType(type);
    return type === "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::emitter::EmitterCreated";
}
...
export class EmitterCreated implements StructClass {
    ...
    private constructor(typeArgs: [], fields: EmitterCreatedFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::emitter::EmitterCreated";
        this.$typeArgs = typeArgs;
...
export function isEmitterDestroyed(type: string): boolean {
    type = compressSuiType(type);
    return type === "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::emitter::EmitterDestroyed";
}
...
export class EmitterDestroyed implements StructClass {
    ...
    private constructor(typeArgs: [], fields: EmitterDestroyedFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::emitter::EmitterDestroyed";
        this.$typeArgs = typeArgs;
