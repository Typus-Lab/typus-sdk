...
export function isGovernanceWitness(type: string): boolean {
    ...
    return type === "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::update_guardian_set::GovernanceWitness";
}
...
export class GovernanceWitness implements StructClass {
    static readonly $typeName =
        "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::update_guardian_set::GovernanceWitness";
    ...
    private constructor(typeArgs: [], fields: GovernanceWitnessFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::update_guardian_set::GovernanceWitness";
...
export function isGuardianSetAdded(type: string): boolean {
    type = compressSuiType(type);
    return type === "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::update_guardian_set::GuardianSetAdded";
}
...
export class GuardianSetAdded implements StructClass {
    ...
    private constructor(typeArgs: [], fields: GuardianSetAddedFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::update_guardian_set::GuardianSetAdded";
        this.$typeArgs = typeArgs;
...
export function isUpdateGuardianSet(type: string): boolean {
    type = compressSuiType(type);
    return type === "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::update_guardian_set::UpdateGuardianSet";
}
...
export class UpdateGuardianSet implements StructClass {
    static readonly $typeName =
        "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::update_guardian_set::UpdateGuardianSet";
    static readonly $numTypeParams = 0;
    ...
    private constructor(typeArgs: [], fields: UpdateGuardianSetFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::update_guardian_set::UpdateGuardianSet";
        this.$typeArgs = typeArgs;
