...
export function isCursor(type: string): boolean {
    ...
    return type.startsWith("0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::cursor::Cursor<");
}
...
export class Cursor<T extends TypeArgument> implements StructClass {
    ...
    private constructor(typeArgs: [ToTypeStr<T>], fields: CursorFields<T>) {
        this.$fullTypeName = composeSuiType(
            Cursor.$typeName,
            ...typeArgs
        ) as `0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::cursor::Cursor<${ToTypeStr<T>}>`;
    ...
    static reified<T extends Reified<TypeArgument, any>>(T: T): CursorReified<ToTypeArgument<T>> {
        return {
            ...
            fullTypeName: composeSuiType(
                Cursor.$typeName,
                ...[extractType(T)]
            ) as `0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::cursor::Cursor<${ToTypeStr<ToTypeArgument<T>>}>`,
