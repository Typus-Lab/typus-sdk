...
export function isBytes20(type: string): boolean {
    ...
    return type === "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::bytes20::Bytes20";
}
...
export class Bytes20 implements StructClass {
    ...
    private constructor(typeArgs: [], fields: Bytes20Fields) {
        this.$fullTypeName = composeSuiType(
            Bytes20.$typeName,
            ...typeArgs
        ) as "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::bytes20::Bytes20";
