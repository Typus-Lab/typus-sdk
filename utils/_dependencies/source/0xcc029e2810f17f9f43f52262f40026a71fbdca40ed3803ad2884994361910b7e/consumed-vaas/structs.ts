...
export function isConsumedVAAs(type: string): boolean {
    ...
    return type === "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::consumed_vaas::ConsumedVAAs";
}
...
export class ConsumedVAAs implements StructClass {
    ...
    private constructor(typeArgs: [], fields: ConsumedVAAsFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::consumed_vaas::ConsumedVAAs";
