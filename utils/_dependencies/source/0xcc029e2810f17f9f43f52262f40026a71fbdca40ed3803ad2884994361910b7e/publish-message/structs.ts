...
export function isMessageTicket(type: string): boolean {
    ...
    return type === "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::publish_message::MessageTicket";
}
...
export class MessageTicket implements StructClass {
    ...
    private constructor(typeArgs: [], fields: MessageTicketFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::publish_message::MessageTicket";
...
export function isWormholeMessage(type: string): boolean {
    type = compressSuiType(type);
    return type === "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::publish_message::WormholeMessage";
}
...
export class WormholeMessage implements StructClass {
    ...
    private constructor(typeArgs: [], fields: WormholeMessageFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::publish_message::WormholeMessage";
        this.$typeArgs = typeArgs;
