...
export function isGuardian(type: string): boolean {
    ...
    return type === "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::guardian::Guardian";
}
...
export class Guardian implements StructClass {
    ...
    private constructor(typeArgs: [], fields: GuardianFields) {
        this.$fullTypeName = composeSuiType(
            Guardian.$typeName,
            ...typeArgs
        ) as "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::guardian::Guardian";
