...
export function isFeeCollector(type: string): boolean {
    ...
    return type === "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::fee_collector::FeeCollector";
}
...
export class FeeCollector implements StructClass {
    ...
    private constructor(typeArgs: [], fields: FeeCollectorFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::fee_collector::FeeCollector";
