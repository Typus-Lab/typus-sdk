...
export function isLatestOnly(type: string): boolean {
    ...
    return type === "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::state::LatestOnly";
}
...
export class LatestOnly implements StructClass {
    ...
    private constructor(typeArgs: [], fields: LatestOnlyFields) {
        this.$fullTypeName = composeSuiType(
            LatestOnly.$typeName,
            ...typeArgs
        ) as "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::state::LatestOnly";
...
export function isState(type: string): boolean {
    type = compressSuiType(type);
    return type === "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::state::State";
}
...
export class State implements StructClass {
    ...
    private constructor(typeArgs: [], fields: StateFields) {
        this.$fullTypeName = composeSuiType(
            State.$typeName,
            ...typeArgs
        ) as "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::state::State";
        this.$typeArgs = typeArgs;
