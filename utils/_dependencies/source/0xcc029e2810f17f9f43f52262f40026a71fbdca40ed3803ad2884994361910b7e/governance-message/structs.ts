...
export function isDecreeReceipt(type: string): boolean {
    ...
    return type.startsWith("0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::governance_message::DecreeReceipt<");
}
...
export class DecreeReceipt<T extends PhantomTypeArgument> implements StructClass {
    ...
    private constructor(typeArgs: [PhantomToTypeStr<T>], fields: DecreeReceiptFields<T>) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::governance_message::DecreeReceipt<${PhantomToTypeStr<T>}>`;
    ...
    static reified<T extends PhantomReified<PhantomTypeArgument>>(T: T): DecreeReceiptReified<ToPhantomTypeArgument<T>> {
        return {
            ...
            fullTypeName: composeSuiType(
                DecreeReceipt.$typeName,
                ...[extractType(T)]
            ) as `0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::governance_message::DecreeReceipt<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
    ...
    static fromJSON<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        assertReifiedTypeArgsMatch(composeSuiType(DecreeReceipt.$typeName, extractType(typeArg)), json.$typeArgs, [typeArg]);
...
export function isDecreeTicket(type: string): boolean {
    type = compressSuiType(type);
    return type.startsWith("0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::governance_message::DecreeTicket<");
}
...
export class DecreeTicket<T extends PhantomTypeArgument> implements StructClass {
    ...
    private constructor(typeArgs: [PhantomToTypeStr<T>], fields: DecreeTicketFields<T>) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::governance_message::DecreeTicket<${PhantomToTypeStr<T>}>`;
        this.$typeArgs = typeArgs;
    ...
    static reified<T extends PhantomReified<PhantomTypeArgument>>(T: T): DecreeTicketReified<ToPhantomTypeArgument<T>> {
        return {
            ...
            fullTypeName: composeSuiType(
                DecreeTicket.$typeName,
                ...[extractType(T)]
            ) as `0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::governance_message::DecreeTicket<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
            typeArgs: [extractType(T)] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>],
            reifiedTypeArgs: [T],
    ...
    static fromJSON<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        assertReifiedTypeArgsMatch(composeSuiType(DecreeTicket.$typeName, extractType(typeArg)), json.$typeArgs, [typeArg]);
