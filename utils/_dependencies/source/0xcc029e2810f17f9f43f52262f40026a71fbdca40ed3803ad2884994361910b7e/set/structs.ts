...
export function isSet(type: string): boolean {
    ...
    return type.startsWith("0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::set::Set<");
}
...
export class Set<T extends PhantomTypeArgument> implements StructClass {
    ...
    private constructor(typeArgs: [PhantomToTypeStr<T>], fields: SetFields<T>) {
        this.$fullTypeName = composeSuiType(
            Set.$typeName,
            ...typeArgs
        ) as `0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::set::Set<${PhantomToTypeStr<T>}>`;
    ...
    static reified<T extends PhantomReified<PhantomTypeArgument>>(T: T): SetReified<ToPhantomTypeArgument<T>> {
        return {
            ...
            fullTypeName: composeSuiType(
                Set.$typeName,
                ...[extractType(T)]
            ) as `0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::set::Set<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
...
export function isEmpty(type: string): boolean {
    type = compressSuiType(type);
    return type === "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::set::Empty";
}
...
export class Empty implements StructClass {
    ...
    private constructor(typeArgs: [], fields: EmptyFields) {
        this.$fullTypeName = composeSuiType(
            Empty.$typeName,
            ...typeArgs
        ) as "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::set::Empty";
        this.$typeArgs = typeArgs;
