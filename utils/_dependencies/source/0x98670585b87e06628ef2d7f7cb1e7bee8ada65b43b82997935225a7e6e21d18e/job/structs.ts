...
export function isJob(type: string): boolean {
    ...
    return type === "0x98670585b87e06628ef2d7f7cb1e7bee8ada65b43b82997935225a7e6e21d18e::job::Job";
}
...
export class Job implements StructClass {
    ...
    private constructor(typeArgs: [], fields: JobFields) {
        this.$fullTypeName = composeSuiType(
            Job.$typeName,
            ...typeArgs
        ) as "0x98670585b87e06628ef2d7f7cb1e7bee8ada65b43b82997935225a7e6e21d18e::job::Job";
