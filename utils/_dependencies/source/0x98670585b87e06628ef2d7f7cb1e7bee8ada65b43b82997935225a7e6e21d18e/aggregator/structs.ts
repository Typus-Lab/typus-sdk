...
export function isAggregator(type: string): boolean {
    ...
    return type === "0x98670585b87e06628ef2d7f7cb1e7bee8ada65b43b82997935225a7e6e21d18e::aggregator::Aggregator";
}
...
export class Aggregator implements StructClass {
    ...
    private constructor(typeArgs: [], fields: AggregatorFields) {
        this.$fullTypeName = composeSuiType(
            Aggregator.$typeName,
            ...typeArgs
        ) as "0x98670585b87e06628ef2d7f7cb1e7bee8ada65b43b82997935225a7e6e21d18e::aggregator::Aggregator";
...
export function isAggregatorHistoryData(type: string): boolean {
    type = compressSuiType(type);
    return type === "0x98670585b87e06628ef2d7f7cb1e7bee8ada65b43b82997935225a7e6e21d18e::aggregator::AggregatorHistoryData";
}
...
export class AggregatorHistoryData implements StructClass {
    ...
    private constructor(typeArgs: [], fields: AggregatorHistoryDataFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0x98670585b87e06628ef2d7f7cb1e7bee8ada65b43b82997935225a7e6e21d18e::aggregator::AggregatorHistoryData";
        this.$typeArgs = typeArgs;
    ...
    toJSONField() {
        return {
            ...
            data: fieldToJSON<Vector<AggregatorHistoryRow>>(
                `vector<0x98670585b87e06628ef2d7f7cb1e7bee8ada65b43b82997935225a7e6e21d18e::aggregator::AggregatorHistoryRow>`,
                this.data
            ),
...
export function isAggregatorHistoryRow(type: string): boolean {
    type = compressSuiType(type);
    return type === "0x98670585b87e06628ef2d7f7cb1e7bee8ada65b43b82997935225a7e6e21d18e::aggregator::AggregatorHistoryRow";
}
...
export class AggregatorHistoryRow implements StructClass {
    ...
    private constructor(typeArgs: [], fields: AggregatorHistoryRowFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0x98670585b87e06628ef2d7f7cb1e7bee8ada65b43b82997935225a7e6e21d18e::aggregator::AggregatorHistoryRow";
        this.$typeArgs = typeArgs;
...
export function isAggregatorJobData(type: string): boolean {
    type = compressSuiType(type);
    return type === "0x98670585b87e06628ef2d7f7cb1e7bee8ada65b43b82997935225a7e6e21d18e::aggregator::AggregatorJobData";
}
...
export class AggregatorJobData implements StructClass {
    ...
    private constructor(typeArgs: [], fields: AggregatorJobDataFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0x98670585b87e06628ef2d7f7cb1e7bee8ada65b43b82997935225a7e6e21d18e::aggregator::AggregatorJobData";
        this.$typeArgs = typeArgs;
...
export function isSlidingWindow(type: string): boolean {
    type = compressSuiType(type);
    return type === "0x98670585b87e06628ef2d7f7cb1e7bee8ada65b43b82997935225a7e6e21d18e::aggregator::SlidingWindow";
}
...
export class SlidingWindow implements StructClass {
    ...
    private constructor(typeArgs: [], fields: SlidingWindowFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0x98670585b87e06628ef2d7f7cb1e7bee8ada65b43b82997935225a7e6e21d18e::aggregator::SlidingWindow";
        this.$typeArgs = typeArgs;
    ...
    toJSONField() {
        return {
            data: fieldToJSON<Vector<SlidingWindowElement>>(
                `vector<0x98670585b87e06628ef2d7f7cb1e7bee8ada65b43b82997935225a7e6e21d18e::aggregator::SlidingWindowElement>`,
                this.data
            ),
...
export function isSlidingWindowElement(type: string): boolean {
    type = compressSuiType(type);
    return type === "0x98670585b87e06628ef2d7f7cb1e7bee8ada65b43b82997935225a7e6e21d18e::aggregator::SlidingWindowElement";
}
...
export class SlidingWindowElement implements StructClass {
    ...
    private constructor(typeArgs: [], fields: SlidingWindowElementFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0x98670585b87e06628ef2d7f7cb1e7bee8ada65b43b82997935225a7e6e21d18e::aggregator::SlidingWindowElement";
        this.$typeArgs = typeArgs;
