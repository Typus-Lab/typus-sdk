...
export function isQuote(type: string): boolean {
    ...
    return type === "0x98670585b87e06628ef2d7f7cb1e7bee8ada65b43b82997935225a7e6e21d18e::quote::Quote";
}
...
export class Quote implements StructClass {
    ...
    private constructor(typeArgs: [], fields: QuoteFields) {
        this.$fullTypeName = composeSuiType(
            Quote.$typeName,
            ...typeArgs
        ) as "0x98670585b87e06628ef2d7f7cb1e7bee8ada65b43b82997935225a7e6e21d18e::quote::Quote";
