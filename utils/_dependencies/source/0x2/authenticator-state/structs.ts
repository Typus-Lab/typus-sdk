...
export class ActiveJwk implements StructClass {
    ...
    static reified(): ActiveJwkReified {
        return {
            ...
            fullTypeName: composeSuiType(ActiveJwk.$typeName, ...[]) as "0x2::authenticator_state::ActiveJwk",
            typeArgs: [] as [],
            reifiedTypeArgs: [],
...
export class AuthenticatorState implements StructClass {
    ...
    private constructor(typeArgs: [], fields: AuthenticatorStateFields) {
        this.$fullTypeName = composeSuiType(AuthenticatorState.$typeName, ...typeArgs) as "0x2::authenticator_state::AuthenticatorState";
        this.$typeArgs = typeArgs;
    ...
    static reified(): AuthenticatorStateReified {
        return {
            ...
            fullTypeName: composeSuiType(AuthenticatorState.$typeName, ...[]) as "0x2::authenticator_state::AuthenticatorState",
            typeArgs: [] as [],
            reifiedTypeArgs: [],
...
export class AuthenticatorStateInner implements StructClass {
    ...
    static reified(): AuthenticatorStateInnerReified {
        return {
            ...
            fullTypeName: composeSuiType(AuthenticatorStateInner.$typeName, ...[]) as "0x2::authenticator_state::AuthenticatorStateInner",
            typeArgs: [] as [],
            reifiedTypeArgs: [],
    ...
    toJSONField() {
        return {
            version: this.version.toString(),
            activeJwks: fieldToJSON<Vector<ActiveJwk>>(`vector<0x2::authenticator_state::ActiveJwk>`, this.activeJwks),
        };
    }
