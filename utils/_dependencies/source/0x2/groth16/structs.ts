...
export class PreparedVerifyingKey implements StructClass {
    ...
    static reified(): PreparedVerifyingKeyReified {
        return {
            ...
            fullTypeName: composeSuiType(PreparedVerifyingKey.$typeName, ...[]) as "0x2::groth16::PreparedVerifyingKey",
            typeArgs: [] as [],
            reifiedTypeArgs: [],
...
export class PublicProofInputs implements StructClass {
    ...
    static reified(): PublicProofInputsReified {
        return {
            ...
            fullTypeName: composeSuiType(PublicProofInputs.$typeName, ...[]) as "0x2::groth16::PublicProofInputs",
            typeArgs: [] as [],
            reifiedTypeArgs: [],
