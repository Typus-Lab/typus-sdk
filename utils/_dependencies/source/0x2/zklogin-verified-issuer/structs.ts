...
export class VerifiedIssuer implements StructClass {
    ...
    private constructor(typeArgs: [], fields: VerifiedIssuerFields) {
        this.$fullTypeName = composeSuiType(VerifiedIssuer.$typeName, ...typeArgs) as "0x2::zklogin_verified_issuer::VerifiedIssuer";
    ...
    static reified(): VerifiedIssuerReified {
        return {
            ...
            fullTypeName: composeSuiType(VerifiedIssuer.$typeName, ...[]) as "0x2::zklogin_verified_issuer::VerifiedIssuer",
            typeArgs: [] as [],
            reifiedTypeArgs: [],
