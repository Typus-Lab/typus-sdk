...
export function isConfig(type: string): boolean {
    ...
    return type === "0xbd8fc1947cf119350184107a3087e2dc27efefa0dd82e25a1f699069fe81a585::kiosk_lock_rule::Config";
}
...
export class Config implements StructClass {
    ...
    private constructor(typeArgs: [], fields: ConfigFields) {
        this.$fullTypeName = composeSuiType(
            Config.$typeName,
            ...typeArgs
        ) as "0xbd8fc1947cf119350184107a3087e2dc27efefa0dd82e25a1f699069fe81a585::kiosk_lock_rule::Config";
    ...
    static fromFields(fields: Record<string, any>): Config {
        return Config.reified().new({ dummyField: decodeFromFields("bool", fields.dummy_field) });
    }
    ...
    static fromJSONField(field: any): Config {
        return Config.reified().new({ dummyField: decodeFromJSONField("bool", field.dummyField) });
    }
...
export function isRule(type: string): boolean {
    type = compressSuiType(type);
    return type === "0xbd8fc1947cf119350184107a3087e2dc27efefa0dd82e25a1f699069fe81a585::kiosk_lock_rule::Rule";
}
...
export class Rule implements StructClass {
    ...
    private constructor(typeArgs: [], fields: RuleFields) {
        this.$fullTypeName = composeSuiType(
            Rule.$typeName,
            ...typeArgs
        ) as "0xbd8fc1947cf119350184107a3087e2dc27efefa0dd82e25a1f699069fe81a585::kiosk_lock_rule::Rule";
        this.$typeArgs = typeArgs;
