...
export function isSupraPrice(type: string): boolean {
    ...
    return type === "0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::supra::SupraPrice";
}
...
export class SupraPrice implements StructClass {
    static readonly $typeName = "0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::supra::SupraPrice";
    static readonly $numTypeParams = 0;

    readonly $typeName = SupraPrice.$typeName;

    readonly $fullTypeName: "0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::supra::SupraPrice";
    ...
    private constructor(typeArgs: [], fields: SupraPriceFields) {
        this.$fullTypeName = composeSuiType(
            SupraPrice.$typeName,
            ...typeArgs
        ) as "0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::supra::SupraPrice";
