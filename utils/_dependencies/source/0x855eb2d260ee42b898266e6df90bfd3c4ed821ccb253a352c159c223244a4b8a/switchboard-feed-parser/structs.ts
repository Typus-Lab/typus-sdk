...
export function isAggregatorInfo(type: string): boolean {
    ...
    return type === "0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::switchboard_feed_parser::AggregatorInfo";
}
...
export class AggregatorInfo implements StructClass {
    static readonly $typeName =
        "0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::switchboard_feed_parser::AggregatorInfo";
    static readonly $numTypeParams = 0;

    readonly $typeName = AggregatorInfo.$typeName;

    readonly $fullTypeName: "0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::switchboard_feed_parser::AggregatorInfo";
    ...
    private constructor(typeArgs: [], fields: AggregatorInfoFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::switchboard_feed_parser::AggregatorInfo";
