...
export function isPythPrice(type: string): boolean {
    ...
    return type === "0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::pyth_parser::PythPrice";
}
...
export class PythPrice implements StructClass {
    static readonly $typeName = "0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::pyth_parser::PythPrice";
    static readonly $numTypeParams = 0;

    readonly $typeName = PythPrice.$typeName;

    readonly $fullTypeName: "0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::pyth_parser::PythPrice";
    ...
    private constructor(typeArgs: [], fields: PythPriceFields) {
        this.$fullTypeName = composeSuiType(
            PythPrice.$typeName,
            ...typeArgs
        ) as "0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::pyth_parser::PythPrice";
...
export function isPythPriceInfoObject(type: string): boolean {
    type = compressSuiType(type);
    return type === "0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::pyth_parser::PythPriceInfoObject";
}
...
export class PythPriceInfoObject implements StructClass {
    static readonly $typeName = "0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::pyth_parser::PythPriceInfoObject";
    static readonly $numTypeParams = 0;

    readonly $typeName = PythPriceInfoObject.$typeName;

    readonly $fullTypeName: "0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::pyth_parser::PythPriceInfoObject";
    ...
    private constructor(typeArgs: [], fields: PythPriceInfoObjectFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::pyth_parser::PythPriceInfoObject";
        this.$typeArgs = typeArgs;
