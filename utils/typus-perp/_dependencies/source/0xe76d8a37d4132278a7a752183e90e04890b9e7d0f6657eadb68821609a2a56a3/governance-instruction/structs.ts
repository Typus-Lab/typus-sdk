...
export function isGovernanceInstruction(type: string): boolean {
    ...
    return type === "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::governance_instruction::GovernanceInstruction";
}
...
export class GovernanceInstruction implements StructClass {
    static readonly $typeName =
        "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::governance_instruction::GovernanceInstruction";
    ...
    private constructor(typeArgs: [], fields: GovernanceInstructionFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::governance_instruction::GovernanceInstruction";
    ...
    static reified(): GovernanceInstructionReified {
        return {
            ...
            fromFieldsWithTypes: (item: FieldsWithTypes) => GovernanceInstruction.fromFieldsWithTypes(item),
            ...
            fromSuiParsedData: (content: SuiParsedData) => GovernanceInstruction.fromSuiParsedData(content),
    ...
    static fromSuiParsedData(content: SuiParsedData): GovernanceInstruction {
        ...
        if (!isGovernanceInstruction(content.type)) {
            throw new Error(`object at ${(content.fields as any).id} is not a GovernanceInstruction object`);
        }
