...
export function isPriceInfo(type: string): boolean {
    ...
    return type === "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::price_info::PriceInfo";
}
...
export class PriceInfo implements StructClass {
    ...
    private constructor(typeArgs: [], fields: PriceInfoFields) {
        this.$fullTypeName = composeSuiType(
            PriceInfo.$typeName,
            ...typeArgs
        ) as "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::price_info::PriceInfo";
...
export function isPriceInfoObject(type: string): boolean {
    type = compressSuiType(type);
    return type === "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::price_info::PriceInfoObject";
}
...
export class PriceInfoObject implements StructClass {
    ...
    private constructor(typeArgs: [], fields: PriceInfoObjectFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::price_info::PriceInfoObject";
        this.$typeArgs = typeArgs;
