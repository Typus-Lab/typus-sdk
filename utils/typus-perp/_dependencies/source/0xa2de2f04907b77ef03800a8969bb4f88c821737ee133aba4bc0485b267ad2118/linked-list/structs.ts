...
export function isNode(type: string): boolean {
    ...
    return type.startsWith("0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::linked_list::Node<");
}
...
export class Node<K extends TypeArgument, V extends TypeArgument> implements StructClass {
    static readonly $typeName = "0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::linked_list::Node";
    static readonly $numTypeParams = 2;

    readonly $typeName = Node.$typeName;

    readonly $fullTypeName: `0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::linked_list::Node<${ToTypeStr<K>}, ${ToTypeStr<V>}>`;
    ...
    private constructor(typeArgs: [ToTypeStr<K>, ToTypeStr<V>], fields: NodeFields<K, V>) {
        this.$fullTypeName = composeSuiType(
            Node.$typeName,
            ...typeArgs
        ) as `0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::linked_list::Node<${ToTypeStr<K>}, ${ToTypeStr<V>}>`;
    ...
    static reified<K extends Reified<TypeArgument, any>, V extends Reified<TypeArgument, any>>(
        ...
        return {
            ...
            ) as `0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::linked_list::Node<${ToTypeStr<ToTypeArgument<K>>}, ${ToTypeStr<ToTypeArgument<V>>}>`,
...
export function isLinkedList(type: string): boolean {
    type = compressSuiType(type);
    return type.startsWith("0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::linked_list::LinkedList<");
}
...
export class LinkedList<K extends TypeArgument, V extends PhantomTypeArgument> implements StructClass {
    static readonly $typeName = "0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::linked_list::LinkedList";
    static readonly $numTypeParams = 2;

    readonly $typeName = LinkedList.$typeName;

    readonly $fullTypeName: `0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::linked_list::LinkedList<${ToTypeStr<K>}, ${PhantomToTypeStr<V>}>`;
    ...
    private constructor(typeArgs: [ToTypeStr<K>, PhantomToTypeStr<V>], fields: LinkedListFields<K, V>) {
        this.$fullTypeName = composeSuiType(
            LinkedList.$typeName,
            ...typeArgs
        ) as `0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::linked_list::LinkedList<${ToTypeStr<K>}, ${PhantomToTypeStr<V>}>`;
        this.$typeArgs = typeArgs;
    ...
    static reified<K extends Reified<TypeArgument, any>, V extends PhantomReified<PhantomTypeArgument>>(
        ...
        return {
            ...
            fullTypeName: composeSuiType(
                LinkedList.$typeName,
                ...[extractType(K), extractType(V)]
            ) as `0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::linked_list::LinkedList<${ToTypeStr<ToTypeArgument<K>>}, ${PhantomToTypeStr<ToPhantomTypeArgument<V>>}>`,
    ...
    toJSONField() {
        return {
            id: this.id,
            first: fieldToJSON<Option<K>>(`0x1::option::Option<${this.$typeArgs[0]}>`, this.first),
            last: fieldToJSON<Option<K>>(`0x1::option::Option<${this.$typeArgs[0]}>`, this.last),
