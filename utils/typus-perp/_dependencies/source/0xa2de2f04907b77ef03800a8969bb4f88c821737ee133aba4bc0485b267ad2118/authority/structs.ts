...
export function isAuthority(type: string): boolean {
    ...
    return type === "0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::authority::Authority";
}
...
export class Authority implements StructClass {
    static readonly $typeName = "0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::authority::Authority";
    static readonly $numTypeParams = 0;

    readonly $typeName = Authority.$typeName;

    readonly $fullTypeName: "0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::authority::Authority";
    ...
    private constructor(typeArgs: [], fields: AuthorityFields) {
        this.$fullTypeName = composeSuiType(
            Authority.$typeName,
            ...typeArgs
        ) as "0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::authority::Authority";
