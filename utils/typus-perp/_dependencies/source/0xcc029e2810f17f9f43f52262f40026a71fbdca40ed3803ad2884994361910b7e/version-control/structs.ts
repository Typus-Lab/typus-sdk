...
export function isV__DUMMY(type: string): boolean {
    ...
    return type === "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::version_control::V__DUMMY";
}
...
export class V__DUMMY implements StructClass {
    ...
    private constructor(typeArgs: [], fields: V__DUMMYFields) {
        this.$fullTypeName = composeSuiType(
            V__DUMMY.$typeName,
            ...typeArgs
        ) as "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::version_control::V__DUMMY";
...
export function isV__0_2_0(type: string): boolean {
    type = compressSuiType(type);
    return type === "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::version_control::V__0_2_0";
}
...
export class V__0_2_0 implements StructClass {
    ...
    private constructor(typeArgs: [], fields: V__0_2_0Fields) {
        this.$fullTypeName = composeSuiType(
            V__0_2_0.$typeName,
            ...typeArgs
        ) as "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::version_control::V__0_2_0";
        this.$typeArgs = typeArgs;
