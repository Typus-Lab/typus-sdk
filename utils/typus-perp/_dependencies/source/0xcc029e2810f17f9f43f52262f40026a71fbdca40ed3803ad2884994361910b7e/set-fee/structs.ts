...
export function isGovernanceWitness(type: string): boolean {
    ...
    return type === "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::set_fee::GovernanceWitness";
}
...
export class GovernanceWitness implements StructClass {
    ...
    private constructor(typeArgs: [], fields: GovernanceWitnessFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::set_fee::GovernanceWitness";
...
export function isSetFee(type: string): boolean {
    type = compressSuiType(type);
    return type === "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::set_fee::SetFee";
}
...
export class SetFee implements StructClass {
    ...
    private constructor(typeArgs: [], fields: SetFeeFields) {
        this.$fullTypeName = composeSuiType(
            SetFee.$typeName,
            ...typeArgs
        ) as "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::set_fee::SetFee";
        this.$typeArgs = typeArgs;
