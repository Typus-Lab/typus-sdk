...
export function isCurrentPackage(type: string): boolean {
    ...
    return type === "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::package_utils::CurrentPackage";
}
...
export class CurrentPackage implements StructClass {
    ...
    private constructor(typeArgs: [], fields: CurrentPackageFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::package_utils::CurrentPackage";
...
export function isCurrentVersion(type: string): boolean {
    type = compressSuiType(type);
    return type === "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::package_utils::CurrentVersion";
}
...
export class CurrentVersion implements StructClass {
    ...
    private constructor(typeArgs: [], fields: CurrentVersionFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::package_utils::CurrentVersion";
        this.$typeArgs = typeArgs;
...
export function isPackageInfo(type: string): boolean {
    type = compressSuiType(type);
    return type === "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::package_utils::PackageInfo";
}
...
export class PackageInfo implements StructClass {
    ...
    private constructor(typeArgs: [], fields: PackageInfoFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::package_utils::PackageInfo";
        this.$typeArgs = typeArgs;
...
export function isPendingPackage(type: string): boolean {
    type = compressSuiType(type);
    return type === "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::package_utils::PendingPackage";
}
...
export class PendingPackage implements StructClass {
    ...
    private constructor(typeArgs: [], fields: PendingPackageFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::package_utils::PendingPackage";
        this.$typeArgs = typeArgs;
