...
export function isVAA(type: string): boolean {
    ...
    return type === "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::vaa::VAA";
}
...
export class VAA implements StructClass {
    ...
    private constructor(typeArgs: [], fields: VAAFields) {
        this.$fullTypeName = composeSuiType(
            VAA.$typeName,
            ...typeArgs
        ) as "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::vaa::VAA";
