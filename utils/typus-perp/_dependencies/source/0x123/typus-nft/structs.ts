...
export class ManagerCap implements StructClass {
    static readonly $typeName = "0x123::typus_nft::ManagerCap";
    static readonly $numTypeParams = 0;

    readonly $typeName = ManagerCap.$typeName;

    readonly $fullTypeName: "0x123::typus_nft::ManagerCap";
    ...
    private constructor(typeArgs: [], fields: ManagerCapFields) {
        this.$fullTypeName = composeSuiType(ManagerCap.$typeName, ...typeArgs) as "0x123::typus_nft::ManagerCap";
    ...
    static reified(): ManagerCapReified {
        return {
            ...
            fullTypeName: composeSuiType(ManagerCap.$typeName, ...[]) as "0x123::typus_nft::ManagerCap",
            typeArgs: [] as [],
            reifiedTypeArgs: [],
...
export class ExpUpEvent implements StructClass {
    static readonly $typeName = "0x123::typus_nft::ExpUpEvent";
    static readonly $numTypeParams = 0;

    readonly $typeName = ExpUpEvent.$typeName;

    readonly $fullTypeName: "0x123::typus_nft::ExpUpEvent";
    ...
    private constructor(typeArgs: [], fields: ExpUpEventFields) {
        this.$fullTypeName = composeSuiType(ExpUpEvent.$typeName, ...typeArgs) as "0x123::typus_nft::ExpUpEvent";
        this.$typeArgs = typeArgs;
    ...
    static reified(): ExpUpEventReified {
        return {
            ...
            fullTypeName: composeSuiType(ExpUpEvent.$typeName, ...[]) as "0x123::typus_nft::ExpUpEvent",
            typeArgs: [] as [],
            reifiedTypeArgs: [],
...
export class FirstBidEvent implements StructClass {
    static readonly $typeName = "0x123::typus_nft::FirstBidEvent";
    static readonly $numTypeParams = 0;

    readonly $typeName = FirstBidEvent.$typeName;

    readonly $fullTypeName: "0x123::typus_nft::FirstBidEvent";
    ...
    private constructor(typeArgs: [], fields: FirstBidEventFields) {
        this.$fullTypeName = composeSuiType(FirstBidEvent.$typeName, ...typeArgs) as "0x123::typus_nft::FirstBidEvent";
        this.$typeArgs = typeArgs;
    ...
    static reified(): FirstBidEventReified {
        return {
            ...
            fullTypeName: composeSuiType(FirstBidEvent.$typeName, ...[]) as "0x123::typus_nft::FirstBidEvent",
            typeArgs: [] as [],
            reifiedTypeArgs: [],
...
export class FirstDepositEvent implements StructClass {
    static readonly $typeName = "0x123::typus_nft::FirstDepositEvent";
    static readonly $numTypeParams = 0;

    readonly $typeName = FirstDepositEvent.$typeName;

    readonly $fullTypeName: "0x123::typus_nft::FirstDepositEvent";
    ...
    private constructor(typeArgs: [], fields: FirstDepositEventFields) {
        this.$fullTypeName = composeSuiType(FirstDepositEvent.$typeName, ...typeArgs) as "0x123::typus_nft::FirstDepositEvent";
        this.$typeArgs = typeArgs;
    ...
    static reified(): FirstDepositEventReified {
        return {
            ...
            fullTypeName: composeSuiType(FirstDepositEvent.$typeName, ...[]) as "0x123::typus_nft::FirstDepositEvent",
            typeArgs: [] as [],
            reifiedTypeArgs: [],
...
export class LevelUpEvent implements StructClass {
    static readonly $typeName = "0x123::typus_nft::LevelUpEvent";
    static readonly $numTypeParams = 0;

    readonly $typeName = LevelUpEvent.$typeName;

    readonly $fullTypeName: "0x123::typus_nft::LevelUpEvent";
    ...
    private constructor(typeArgs: [], fields: LevelUpEventFields) {
        this.$fullTypeName = composeSuiType(LevelUpEvent.$typeName, ...typeArgs) as "0x123::typus_nft::LevelUpEvent";
        this.$typeArgs = typeArgs;
    ...
    static reified(): LevelUpEventReified {
        return {
            ...
            fullTypeName: composeSuiType(LevelUpEvent.$typeName, ...[]) as "0x123::typus_nft::LevelUpEvent",
            typeArgs: [] as [],
            reifiedTypeArgs: [],
...
export class MintEvent implements StructClass {
    static readonly $typeName = "0x123::typus_nft::MintEvent";
    static readonly $numTypeParams = 0;

    readonly $typeName = MintEvent.$typeName;

    readonly $fullTypeName: "0x123::typus_nft::MintEvent";
    ...
    private constructor(typeArgs: [], fields: MintEventFields) {
        this.$fullTypeName = composeSuiType(MintEvent.$typeName, ...typeArgs) as "0x123::typus_nft::MintEvent";
        this.$typeArgs = typeArgs;
    ...
    static reified(): MintEventReified {
        return {
            ...
            fullTypeName: composeSuiType(MintEvent.$typeName, ...[]) as "0x123::typus_nft::MintEvent",
            typeArgs: [] as [],
            reifiedTypeArgs: [],
...
export class NewManagerCapEvent implements StructClass {
    static readonly $typeName = "0x123::typus_nft::NewManagerCapEvent";
    static readonly $numTypeParams = 0;

    readonly $typeName = NewManagerCapEvent.$typeName;

    readonly $fullTypeName: "0x123::typus_nft::NewManagerCapEvent";
    ...
    private constructor(typeArgs: [], fields: NewManagerCapEventFields) {
        this.$fullTypeName = composeSuiType(NewManagerCapEvent.$typeName, ...typeArgs) as "0x123::typus_nft::NewManagerCapEvent";
        this.$typeArgs = typeArgs;
    ...
    static reified(): NewManagerCapEventReified {
        return {
            ...
            fullTypeName: composeSuiType(NewManagerCapEvent.$typeName, ...[]) as "0x123::typus_nft::NewManagerCapEvent",
            typeArgs: [] as [],
            reifiedTypeArgs: [],
...
export class Pool implements StructClass {
    static readonly $typeName = "0x123::typus_nft::Pool";
    static readonly $numTypeParams = 0;

    readonly $typeName = Pool.$typeName;

    readonly $fullTypeName: "0x123::typus_nft::Pool";
    ...
    private constructor(typeArgs: [], fields: PoolFields) {
        this.$fullTypeName = composeSuiType(Pool.$typeName, ...typeArgs) as "0x123::typus_nft::Pool";
        this.$typeArgs = typeArgs;
    ...
    static reified(): PoolReified {
        return {
            ...
            fullTypeName: composeSuiType(Pool.$typeName, ...[]) as "0x123::typus_nft::Pool",
            typeArgs: [] as [],
            reifiedTypeArgs: [],
...
export class Royalty implements StructClass {
    static readonly $typeName = "0x123::typus_nft::Royalty";
    static readonly $numTypeParams = 0;

    readonly $typeName = Royalty.$typeName;

    readonly $fullTypeName: "0x123::typus_nft::Royalty";
    ...
    private constructor(typeArgs: [], fields: RoyaltyFields) {
        this.$fullTypeName = composeSuiType(Royalty.$typeName, ...typeArgs) as "0x123::typus_nft::Royalty";
        this.$typeArgs = typeArgs;
    ...
    static reified(): RoyaltyReified {
        return {
            ...
            fullTypeName: composeSuiType(Royalty.$typeName, ...[]) as "0x123::typus_nft::Royalty",
            typeArgs: [] as [],
            reifiedTypeArgs: [],
...
export class RoyaltyUpdateEvent implements StructClass {
    static readonly $typeName = "0x123::typus_nft::RoyaltyUpdateEvent";
    static readonly $numTypeParams = 0;

    readonly $typeName = RoyaltyUpdateEvent.$typeName;

    readonly $fullTypeName: "0x123::typus_nft::RoyaltyUpdateEvent";
    ...
    private constructor(typeArgs: [], fields: RoyaltyUpdateEventFields) {
        this.$fullTypeName = composeSuiType(RoyaltyUpdateEvent.$typeName, ...typeArgs) as "0x123::typus_nft::RoyaltyUpdateEvent";
        this.$typeArgs = typeArgs;
    ...
    static reified(): RoyaltyUpdateEventReified {
        return {
            ...
            fullTypeName: composeSuiType(RoyaltyUpdateEvent.$typeName, ...[]) as "0x123::typus_nft::RoyaltyUpdateEvent",
            typeArgs: [] as [],
            reifiedTypeArgs: [],
...
export class TYPUS_NFT implements StructClass {
    static readonly $typeName = "0x123::typus_nft::TYPUS_NFT";
    static readonly $numTypeParams = 0;

    readonly $typeName = TYPUS_NFT.$typeName;

    readonly $fullTypeName: "0x123::typus_nft::TYPUS_NFT";
    ...
    private constructor(typeArgs: [], fields: TYPUS_NFTFields) {
        this.$fullTypeName = composeSuiType(TYPUS_NFT.$typeName, ...typeArgs) as "0x123::typus_nft::TYPUS_NFT";
        this.$typeArgs = typeArgs;
    ...
    static reified(): TYPUS_NFTReified {
        return {
            ...
            fullTypeName: composeSuiType(TYPUS_NFT.$typeName, ...[]) as "0x123::typus_nft::TYPUS_NFT",
            typeArgs: [] as [],
            reifiedTypeArgs: [],
    ...
    static fromFields(fields: Record<string, any>): TYPUS_NFT {
        return TYPUS_NFT.reified().new({ dummyField: decodeFromFields("bool", fields.dummy_field) });
    }
    ...
    static fromJSONField(field: any): TYPUS_NFT {
        return TYPUS_NFT.reified().new({ dummyField: decodeFromJSONField("bool", field.dummyField) });
    }
...
export class Tails implements StructClass {
    static readonly $typeName = "0x123::typus_nft::Tails";
    static readonly $numTypeParams = 0;

    readonly $typeName = Tails.$typeName;

    readonly $fullTypeName: "0x123::typus_nft::Tails";
    ...
    private constructor(typeArgs: [], fields: TailsFields) {
        this.$fullTypeName = composeSuiType(Tails.$typeName, ...typeArgs) as "0x123::typus_nft::Tails";
        this.$typeArgs = typeArgs;
    ...
    static reified(): TailsReified {
        return {
            ...
            fullTypeName: composeSuiType(Tails.$typeName, ...[]) as "0x123::typus_nft::Tails",
            typeArgs: [] as [],
            reifiedTypeArgs: [],
...
export class Whitelist implements StructClass {
    static readonly $typeName = "0x123::typus_nft::Whitelist";
    static readonly $numTypeParams = 0;

    readonly $typeName = Whitelist.$typeName;

    readonly $fullTypeName: "0x123::typus_nft::Whitelist";
    ...
    private constructor(typeArgs: [], fields: WhitelistFields) {
        this.$fullTypeName = composeSuiType(Whitelist.$typeName, ...typeArgs) as "0x123::typus_nft::Whitelist";
        this.$typeArgs = typeArgs;
    ...
    static reified(): WhitelistReified {
        return {
            ...
            fullTypeName: composeSuiType(Whitelist.$typeName, ...[]) as "0x123::typus_nft::Whitelist",
            typeArgs: [] as [],
            reifiedTypeArgs: [],
    ...
    static fromFields(fields: Record<string, any>): Whitelist {
        return Whitelist.reified().new({ id: decodeFromFields(UID.reified(), fields.id), for: decodeFromFields(ID.reified(), fields.for) });
    }
