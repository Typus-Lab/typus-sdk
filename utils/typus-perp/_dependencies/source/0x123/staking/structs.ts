...
export function isManagerCap(type: string): boolean {
    ...
    return type === "0x123::staking::ManagerCap";
}
...
export class ManagerCap implements StructClass {
    static readonly $typeName = "0x123::staking::ManagerCap";
    static readonly $numTypeParams = 0;

    readonly $typeName = ManagerCap.$typeName;

    readonly $fullTypeName: "0x123::staking::ManagerCap";
    ...
    private constructor(typeArgs: [], fields: ManagerCapFields) {
        this.$fullTypeName = composeSuiType(ManagerCap.$typeName, ...typeArgs) as "0x123::staking::ManagerCap";
    ...
    static reified(): ManagerCapReified {
        return {
            ...
            fullTypeName: composeSuiType(ManagerCap.$typeName, ...[]) as "0x123::staking::ManagerCap",
            typeArgs: [] as [],
            reifiedTypeArgs: [],
...
export function isRegistry(type: string): boolean {
    type = compressSuiType(type);
    return type === "0x123::staking::Registry";
}
...
export class Registry implements StructClass {
    static readonly $typeName = "0x123::staking::Registry";
    static readonly $numTypeParams = 0;

    readonly $typeName = Registry.$typeName;

    readonly $fullTypeName: "0x123::staking::Registry";
    ...
    private constructor(typeArgs: [], fields: RegistryFields) {
        this.$fullTypeName = composeSuiType(Registry.$typeName, ...typeArgs) as "0x123::staking::Registry";
        this.$typeArgs = typeArgs;
    ...
    static reified(): RegistryReified {
        return {
            ...
            fullTypeName: composeSuiType(Registry.$typeName, ...[]) as "0x123::staking::Registry",
            typeArgs: [] as [],
            reifiedTypeArgs: [],
...
export function isLevelUpEvent(type: string): boolean {
    type = compressSuiType(type);
    return type === "0x123::staking::LevelUpEvent";
}
...
export class LevelUpEvent implements StructClass {
    static readonly $typeName = "0x123::staking::LevelUpEvent";
    static readonly $numTypeParams = 0;

    readonly $typeName = LevelUpEvent.$typeName;

    readonly $fullTypeName: "0x123::staking::LevelUpEvent";
    ...
    private constructor(typeArgs: [], fields: LevelUpEventFields) {
        this.$fullTypeName = composeSuiType(LevelUpEvent.$typeName, ...typeArgs) as "0x123::staking::LevelUpEvent";
        this.$typeArgs = typeArgs;
    ...
    static reified(): LevelUpEventReified {
        return {
            ...
            fullTypeName: composeSuiType(LevelUpEvent.$typeName, ...[]) as "0x123::staking::LevelUpEvent",
            typeArgs: [] as [],
            reifiedTypeArgs: [],
...
export function isNftExtension(type: string): boolean {
    type = compressSuiType(type);
    return type === "0x123::staking::NftExtension";
}
...
export class NftExtension implements StructClass {
    static readonly $typeName = "0x123::staking::NftExtension";
    static readonly $numTypeParams = 0;

    readonly $typeName = NftExtension.$typeName;

    readonly $fullTypeName: "0x123::staking::NftExtension";
    ...
    private constructor(typeArgs: [], fields: NftExtensionFields) {
        this.$fullTypeName = composeSuiType(NftExtension.$typeName, ...typeArgs) as "0x123::staking::NftExtension";
        this.$typeArgs = typeArgs;
    ...
    static reified(): NftExtensionReified {
        return {
            ...
            fullTypeName: composeSuiType(NftExtension.$typeName, ...[]) as "0x123::staking::NftExtension",
            typeArgs: [] as [],
            reifiedTypeArgs: [],
...
export function isStakingTails(type: string): boolean {
    type = compressSuiType(type);
    return type === "0x123::staking::StakingTails";
}
...
export class StakingTails implements StructClass {
    static readonly $typeName = "0x123::staking::StakingTails";
    static readonly $numTypeParams = 0;

    readonly $typeName = StakingTails.$typeName;

    readonly $fullTypeName: "0x123::staking::StakingTails";
    ...
    private constructor(typeArgs: [], fields: StakingTailsFields) {
        this.$fullTypeName = composeSuiType(StakingTails.$typeName, ...typeArgs) as "0x123::staking::StakingTails";
        this.$typeArgs = typeArgs;
    ...
    static reified(): StakingTailsReified {
        return {
            ...
            fullTypeName: composeSuiType(StakingTails.$typeName, ...[]) as "0x123::staking::StakingTails",
            typeArgs: [] as [],
            reifiedTypeArgs: [],
