...
export function isTableVec(type: string): boolean {
    ...
    return type.startsWith("0x123::table_vec::TableVec<");
}
...
export class TableVec<Element extends PhantomTypeArgument> implements StructClass {
    static readonly $typeName = "0x123::table_vec::TableVec";
    static readonly $numTypeParams = 1;

    readonly $typeName = TableVec.$typeName;

    readonly $fullTypeName: `0x123::table_vec::TableVec<${PhantomToTypeStr<Element>}>`;
    ...
    private constructor(typeArgs: [PhantomToTypeStr<Element>], fields: TableVecFields<Element>) {
        this.$fullTypeName = composeSuiType(TableVec.$typeName, ...typeArgs) as `0x123::table_vec::TableVec<${PhantomToTypeStr<Element>}>`;
    ...
    static reified<Element extends PhantomReified<PhantomTypeArgument>>(Element: Element): TableVecReified<ToPhantomTypeArgument<Element>> {
        return {
            ...
            fullTypeName: composeSuiType(
                TableVec.$typeName,
                ...[extractType(Element)]
            ) as `0x123::table_vec::TableVec<${PhantomToTypeStr<ToPhantomTypeArgument<Element>>}>`,
