...
export function isFeeInfo(type: string): boolean {
    ...
    return type === "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::ecosystem::FeeInfo";
}
...
export class FeeInfo implements StructClass {
    static readonly $typeName = "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::ecosystem::FeeInfo";
    static readonly $numTypeParams = 0;

    readonly $typeName = FeeInfo.$typeName;

    readonly $fullTypeName: "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::ecosystem::FeeInfo";
    ...
    private constructor(typeArgs: [], fields: FeeInfoFields) {
        this.$fullTypeName = composeSuiType(
            FeeInfo.$typeName,
            ...typeArgs
        ) as "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::ecosystem::FeeInfo";
...
export function isFeePool(type: string): boolean {
    type = compressSuiType(type);
    return type === "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::ecosystem::FeePool";
}
...
export class FeePool implements StructClass {
    static readonly $typeName = "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::ecosystem::FeePool";
    static readonly $numTypeParams = 0;

    readonly $typeName = FeePool.$typeName;

    readonly $fullTypeName: "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::ecosystem::FeePool";
    ...
    private constructor(typeArgs: [], fields: FeePoolFields) {
        this.$fullTypeName = composeSuiType(
            FeePool.$typeName,
            ...typeArgs
        ) as "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::ecosystem::FeePool";
        this.$typeArgs = typeArgs;
    ...
    toJSONField() {
        return {
            ...
            feeInfos: fieldToJSON<Vector<FeeInfo>>(
                `vector<0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::ecosystem::FeeInfo>`,
                this.feeInfos
            ),
        };
    }
...
export function isManagerCap(type: string): boolean {
    type = compressSuiType(type);
    return type === "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::ecosystem::ManagerCap";
}
...
export class ManagerCap implements StructClass {
    static readonly $typeName = "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::ecosystem::ManagerCap";
    static readonly $numTypeParams = 0;

    readonly $typeName = ManagerCap.$typeName;

    readonly $fullTypeName: "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::ecosystem::ManagerCap";
    ...
    private constructor(typeArgs: [], fields: ManagerCapFields) {
        this.$fullTypeName = composeSuiType(
            ManagerCap.$typeName,
            ...typeArgs
        ) as "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::ecosystem::ManagerCap";
        this.$typeArgs = typeArgs;
...
export function isSendFeeEvent(type: string): boolean {
    type = compressSuiType(type);
    return type === "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::ecosystem::SendFeeEvent";
}
...
export class SendFeeEvent implements StructClass {
    static readonly $typeName = "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::ecosystem::SendFeeEvent";
    static readonly $numTypeParams = 0;

    readonly $typeName = SendFeeEvent.$typeName;

    readonly $fullTypeName: "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::ecosystem::SendFeeEvent";
    ...
    private constructor(typeArgs: [], fields: SendFeeEventFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::ecosystem::SendFeeEvent";
        this.$typeArgs = typeArgs;
...
export function isVersion(type: string): boolean {
    type = compressSuiType(type);
    return type === "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::ecosystem::Version";
}
...
export class Version implements StructClass {
    static readonly $typeName = "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::ecosystem::Version";
    static readonly $numTypeParams = 0;

    readonly $typeName = Version.$typeName;

    readonly $fullTypeName: "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::ecosystem::Version";
    ...
    private constructor(typeArgs: [], fields: VersionFields) {
        this.$fullTypeName = composeSuiType(
            Version.$typeName,
            ...typeArgs
        ) as "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::ecosystem::Version";
        this.$typeArgs = typeArgs;
