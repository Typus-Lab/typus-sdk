...
export function isBigVector(type: string): boolean {
    ...
    return type === "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::big_vector::BigVector";
}
...
export class BigVector implements StructClass {
    static readonly $typeName = "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::big_vector::BigVector";
    static readonly $numTypeParams = 0;

    readonly $typeName = BigVector.$typeName;

    readonly $fullTypeName: "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::big_vector::BigVector";
    ...
    private constructor(typeArgs: [], fields: BigVectorFields) {
        this.$fullTypeName = composeSuiType(
            BigVector.$typeName,
            ...typeArgs
        ) as "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::big_vector::BigVector";
...
export function isSlice(type: string): boolean {
    type = compressSuiType(type);
    return type.startsWith("0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::big_vector::Slice<");
}
...
export class Slice<Element extends TypeArgument> implements StructClass {
    static readonly $typeName = "0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::big_vector::Slice";
    static readonly $numTypeParams = 1;

    readonly $typeName = Slice.$typeName;

    readonly $fullTypeName: `0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::big_vector::Slice<${ToTypeStr<Element>}>`;
    ...
    private constructor(typeArgs: [ToTypeStr<Element>], fields: SliceFields<Element>) {
        this.$fullTypeName = composeSuiType(
            Slice.$typeName,
            ...typeArgs
        ) as `0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::big_vector::Slice<${ToTypeStr<Element>}>`;
        this.$typeArgs = typeArgs;
    ...
    static reified<Element extends Reified<TypeArgument, any>>(Element: Element): SliceReified<ToTypeArgument<Element>> {
        return {
            ...
            fullTypeName: composeSuiType(
                Slice.$typeName,
                ...[extractType(Element)]
            ) as `0x17117e8e181c236a3d1706f8a60486676cc9a5c82dc58d132a2f8270598271d::big_vector::Slice<${ToTypeStr<ToTypeArgument<Element>>}>`,
