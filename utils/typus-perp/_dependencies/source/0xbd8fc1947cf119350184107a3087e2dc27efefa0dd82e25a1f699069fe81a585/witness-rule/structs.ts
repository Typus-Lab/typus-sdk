...
export function isRule(type: string): boolean {
    ...
    return type.startsWith("0xbd8fc1947cf119350184107a3087e2dc27efefa0dd82e25a1f699069fe81a585::witness_rule::Rule<");
}
...
export class Rule<Proof extends PhantomTypeArgument> implements StructClass {
    ...
    private constructor(typeArgs: [PhantomToTypeStr<Proof>], fields: RuleFields<Proof>) {
        this.$fullTypeName = composeSuiType(
            Rule.$typeName,
            ...typeArgs
        ) as `0xbd8fc1947cf119350184107a3087e2dc27efefa0dd82e25a1f699069fe81a585::witness_rule::Rule<${PhantomToTypeStr<Proof>}>`;
    ...
    static reified<Proof extends PhantomReified<PhantomTypeArgument>>(Proof: Proof): RuleReified<ToPhantomTypeArgument<Proof>> {
        return {
            ...
            fullTypeName: composeSuiType(
                Rule.$typeName,
                ...[extractType(Proof)]
            ) as `0xbd8fc1947cf119350184107a3087e2dc27efefa0dd82e25a1f699069fe81a585::witness_rule::Rule<${PhantomToTypeStr<ToPhantomTypeArgument<Proof>>}>`,
