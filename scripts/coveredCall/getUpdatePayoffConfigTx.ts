...
(async () => {
    ...
    let price = 4000
    let roi = 1000
    let exposureRatio = 100000

    let updatePayoffConfigTx: any = await getUpdatePayoffConfigTx(COVERED_CALL_PACKAGE, COVERED_CALL_REGISTRY, DEFAULT_TYPE_ARGUMENT, COVERED_CALL_MANAGER, index, price, roi, exposureRatio);
