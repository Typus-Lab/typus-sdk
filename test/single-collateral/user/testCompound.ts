...
import { getCompoundTx } from "../../../utils/portfolio/single-collateral/user/getCompoundTx";
...
(async () => {
    ...
    let transactionBlock = await getCompoundTx(gasBudget, PORTFOLIO_PACKAGE, MODULE, REGISTRY, typeArguments, index);
