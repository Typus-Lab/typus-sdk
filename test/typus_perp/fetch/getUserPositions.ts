...
import "../../load_env";
import { Position } from "../../../utils/typus_perp/position/structs";
...
(async () => {
    ...
    getUserPositions(config.PACKAGE.LOCKED_VAULT, tx, {
    ...
    const positions = bcs.vector(Position.bcs).parse(Uint8Array.from(returnValues));
