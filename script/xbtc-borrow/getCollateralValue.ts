...
(async () => {
    ...
    let target = `0x81c408448d0d57b3e371ea94de1d40bf852784d3e225de1e74acab3e8395c18f::logic::user_collateral_value` as any;
    ...
    // @ts-ignore
    console.log("SUI: " + new BcsReader(new Uint8Array(results[0].returnValues[0].bcs)).read256());
    // @ts-ignore
    console.log("USDC: " + new BcsReader(new Uint8Array(results[1].returnValues[0].bcs)).read256());
})();
