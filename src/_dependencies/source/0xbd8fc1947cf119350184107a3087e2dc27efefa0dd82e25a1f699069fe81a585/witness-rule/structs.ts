...
export function isRule(type: string): boolean { type = compressSuiType(type); return type.startsWith("0xbd8fc1947cf119350184107a3087e2dc27efefa0dd82e25a1f699069fe81a585::witness_rule::Rule<"); }
...
export class Rule<Proof extends PhantomTypeArgument> implements StructClass { static readonly $typeName = "0xbd8fc1947cf119350184107a3087e2dc27efefa0dd82e25a1f699069fe81a585::witness_rule::Rule"; static readonly $numTypeParams = 1;
