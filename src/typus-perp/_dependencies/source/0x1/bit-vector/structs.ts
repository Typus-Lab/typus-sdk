...
export class BitVector implements StructClass {
    ...
    private constructor(typeArgs: [], fields: BitVectorFields) {
        this.$fullTypeName = composeSuiType(BitVector.$typeName, ...typeArgs) as `${typeof PKG_V13}::bit_vector::BitVector`;
    ...
    static reified(): BitVectorReified {
        return {
            ...
            fullTypeName: composeSuiType(BitVector.$typeName, ...[]) as `${typeof PKG_V13}::bit_vector::BitVector`,
            typeArgs: [] as [],
