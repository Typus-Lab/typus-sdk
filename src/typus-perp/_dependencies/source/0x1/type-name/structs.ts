...
export class TypeName implements StructClass {
    ...
    private constructor(typeArgs: [], fields: TypeNameFields) {
        this.$fullTypeName = composeSuiType(TypeName.$typeName, ...typeArgs) as `${typeof PKG_V13}::type_name::TypeName`;
    ...
    static reified(): TypeNameReified {
        return {
            ...
            fullTypeName: composeSuiType(TypeName.$typeName, ...[]) as `${typeof PKG_V13}::type_name::TypeName`,
            typeArgs: [] as [],
