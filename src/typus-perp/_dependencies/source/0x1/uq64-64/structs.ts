...
export class UQ64_64 implements StructClass {
    ...
    private constructor(typeArgs: [], fields: UQ64_64Fields) {
        this.$fullTypeName = composeSuiType(UQ64_64.$typeName, ...typeArgs) as `${typeof PKG_V13}::uq64_64::UQ64_64`;
    ...
    static reified(): UQ64_64Reified {
        return {
            ...
            fullTypeName: composeSuiType(UQ64_64.$typeName, ...[]) as `${typeof PKG_V13}::uq64_64::UQ64_64`,
            typeArgs: [] as [],
