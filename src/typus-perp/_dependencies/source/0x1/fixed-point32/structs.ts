...
export class FixedPoint32 implements StructClass {
    ...
    private constructor(typeArgs: [], fields: FixedPoint32Fields) {
        this.$fullTypeName = composeSuiType(FixedPoint32.$typeName, ...typeArgs) as `${typeof PKG_V13}::fixed_point32::FixedPoint32`;
    ...
    static reified(): FixedPoint32Reified {
        return {
            ...
            fullTypeName: composeSuiType(FixedPoint32.$typeName, ...[]) as `${typeof PKG_V13}::fixed_point32::FixedPoint32`,
            typeArgs: [] as [],
