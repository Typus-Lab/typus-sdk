...
export class GovernanceWitness implements StructClass {
    ...
    private constructor(typeArgs: [], fields: GovernanceWitnessFields) {
        this.$fullTypeName = composeSuiType(GovernanceWitness.$typeName, ...typeArgs) as `${typeof PKG_V1}::set_fee::GovernanceWitness`;
    ...
    static reified(): GovernanceWitnessReified {
        return {
            ...
            fullTypeName: composeSuiType(GovernanceWitness.$typeName, ...[]) as `${typeof PKG_V1}::set_fee::GovernanceWitness`,
            typeArgs: [] as [],
...
export class SetFee implements StructClass {
    ...
    private constructor(typeArgs: [], fields: SetFeeFields) {
        this.$fullTypeName = composeSuiType(SetFee.$typeName, ...typeArgs) as `${typeof PKG_V1}::set_fee::SetFee`;
        this.$typeArgs = typeArgs;
