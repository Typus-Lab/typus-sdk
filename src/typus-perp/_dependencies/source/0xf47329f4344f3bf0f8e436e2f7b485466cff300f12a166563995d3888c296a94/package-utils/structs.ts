...
export class CurrentVersion implements StructClass {
    ...
    private constructor(typeArgs: [], fields: CurrentVersionFields) {
        this.$fullTypeName = composeSuiType(CurrentVersion.$typeName, ...typeArgs) as `${typeof PKG_V1}::package_utils::CurrentVersion`;
    ...
    static reified(): CurrentVersionReified {
        return {
            ...
            fullTypeName: composeSuiType(CurrentVersion.$typeName, ...[]) as `${typeof PKG_V1}::package_utils::CurrentVersion`,
            typeArgs: [] as [],
...
export class CurrentPackage implements StructClass {
    ...
    private constructor(typeArgs: [], fields: CurrentPackageFields) {
        this.$fullTypeName = composeSuiType(CurrentPackage.$typeName, ...typeArgs) as `${typeof PKG_V1}::package_utils::CurrentPackage`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): CurrentPackageReified {
        return {
            ...
            fullTypeName: composeSuiType(CurrentPackage.$typeName, ...[]) as `${typeof PKG_V1}::package_utils::CurrentPackage`,
            typeArgs: [] as [],
...
export class PackageInfo implements StructClass {
    ...
    private constructor(typeArgs: [], fields: PackageInfoFields) {
        this.$fullTypeName = composeSuiType(PackageInfo.$typeName, ...typeArgs) as `${typeof PKG_V1}::package_utils::PackageInfo`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): PackageInfoReified {
        return {
            ...
            fullTypeName: composeSuiType(PackageInfo.$typeName, ...[]) as `${typeof PKG_V1}::package_utils::PackageInfo`,
            typeArgs: [] as [],
...
export class PendingPackage implements StructClass {
    ...
    private constructor(typeArgs: [], fields: PendingPackageFields) {
        this.$fullTypeName = composeSuiType(PendingPackage.$typeName, ...typeArgs) as `${typeof PKG_V1}::package_utils::PendingPackage`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): PendingPackageReified {
        return {
            ...
            fullTypeName: composeSuiType(PendingPackage.$typeName, ...[]) as `${typeof PKG_V1}::package_utils::PendingPackage`,
            typeArgs: [] as [],
