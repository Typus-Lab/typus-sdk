...
export class GuardianSet implements StructClass {
    ...
    private constructor(typeArgs: [], fields: GuardianSetFields) {
        this.$fullTypeName = composeSuiType(GuardianSet.$typeName, ...typeArgs) as `${typeof PKG_V1}::guardian_set::GuardianSet`;
    ...
    static reified(): GuardianSetReified {
        return {
            ...
            fullTypeName: composeSuiType(GuardianSet.$typeName, ...[]) as `${typeof PKG_V1}::guardian_set::GuardianSet`,
            typeArgs: [] as [],
