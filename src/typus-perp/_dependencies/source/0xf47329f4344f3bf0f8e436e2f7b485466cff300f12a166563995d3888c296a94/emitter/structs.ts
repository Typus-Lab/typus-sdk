...
export class EmitterCap implements StructClass {
    ...
    private constructor(typeArgs: [], fields: EmitterCapFields) {
        this.$fullTypeName = composeSuiType(EmitterCap.$typeName, ...typeArgs) as `${typeof PKG_V1}::emitter::EmitterCap`;
    ...
    static reified(): EmitterCapReified {
        return {
            ...
            fullTypeName: composeSuiType(EmitterCap.$typeName, ...[]) as `${typeof PKG_V1}::emitter::EmitterCap`,
            typeArgs: [] as [],
...
export class EmitterCreated implements StructClass {
    ...
    private constructor(typeArgs: [], fields: EmitterCreatedFields) {
        this.$fullTypeName = composeSuiType(EmitterCreated.$typeName, ...typeArgs) as `${typeof PKG_V1}::emitter::EmitterCreated`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): EmitterCreatedReified {
        return {
            ...
            fullTypeName: composeSuiType(EmitterCreated.$typeName, ...[]) as `${typeof PKG_V1}::emitter::EmitterCreated`,
            typeArgs: [] as [],
...
export class EmitterDestroyed implements StructClass {
    ...
    private constructor(typeArgs: [], fields: EmitterDestroyedFields) {
        this.$fullTypeName = composeSuiType(EmitterDestroyed.$typeName, ...typeArgs) as `${typeof PKG_V1}::emitter::EmitterDestroyed`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): EmitterDestroyedReified {
        return {
            ...
            fullTypeName: composeSuiType(EmitterDestroyed.$typeName, ...[]) as `${typeof PKG_V1}::emitter::EmitterDestroyed`,
            typeArgs: [] as [],
