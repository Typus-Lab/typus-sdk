...
export class FeeCollector implements StructClass {
    ...
    private constructor(typeArgs: [], fields: FeeCollectorFields) {
        this.$fullTypeName = composeSuiType(FeeCollector.$typeName, ...typeArgs) as `${typeof PKG_V1}::fee_collector::FeeCollector`;
    ...
    static reified(): FeeCollectorReified {
        return {
            ...
            fullTypeName: composeSuiType(FeeCollector.$typeName, ...[]) as `${typeof PKG_V1}::fee_collector::FeeCollector`,
            typeArgs: [] as [],
