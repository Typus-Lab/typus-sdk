...
export class ContractUpgraded implements StructClass {
    ...
    static reified(): ContractUpgradedReified {
        return {
            ...
            fullTypeName: composeSuiType(ContractUpgraded.$typeName, ...[]) as `${typeof PKG_V1}::upgrade_contract::ContractUpgraded`,
            typeArgs: [] as [],
...
export class UpgradeContract implements StructClass {
    ...
    static reified(): UpgradeContractReified {
        return {
            ...
            fullTypeName: composeSuiType(UpgradeContract.$typeName, ...[]) as `${typeof PKG_V1}::upgrade_contract::UpgradeContract`,
            typeArgs: [] as [],
...
export class GovernanceWitness implements StructClass {
    ...
    static reified(): GovernanceWitnessReified {
        return {
            ...
            fullTypeName: composeSuiType(GovernanceWitness.$typeName, ...[]) as `${typeof PKG_V1}::upgrade_contract::GovernanceWitness`,
            typeArgs: [] as [],
