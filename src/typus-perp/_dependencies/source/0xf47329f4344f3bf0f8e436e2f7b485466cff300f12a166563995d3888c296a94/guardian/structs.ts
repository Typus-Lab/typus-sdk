...
export class Guardian implements StructClass {
    ...
    private constructor(typeArgs: [], fields: GuardianFields) {
        this.$fullTypeName = composeSuiType(Guardian.$typeName, ...typeArgs) as `${typeof PKG_V1}::guardian::Guardian`;
    ...
    static reified(): GuardianReified {
        return {
            ...
            fullTypeName: composeSuiType(Guardian.$typeName, ...[]) as `${typeof PKG_V1}::guardian::Guardian`,
            typeArgs: [] as [],
