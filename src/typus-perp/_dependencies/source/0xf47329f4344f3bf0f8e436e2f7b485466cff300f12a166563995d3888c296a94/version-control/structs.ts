...
export class V__0_2_0 implements StructClass {
    ...
    private constructor(typeArgs: [], fields: V__0_2_0Fields) {
        this.$fullTypeName = composeSuiType(V__0_2_0.$typeName, ...typeArgs) as `${typeof PKG_V1}::version_control::V__0_2_0`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): V__0_2_0Reified {
        return {
            ...
            fullTypeName: composeSuiType(V__0_2_0.$typeName, ...[]) as `${typeof PKG_V1}::version_control::V__0_2_0`,
            typeArgs: [] as [],
