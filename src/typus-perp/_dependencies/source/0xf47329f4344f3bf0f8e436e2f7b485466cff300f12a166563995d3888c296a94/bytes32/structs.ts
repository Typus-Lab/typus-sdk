...
export class Bytes32 implements StructClass {
    ...
    private constructor(typeArgs: [], fields: Bytes32Fields) {
        this.$fullTypeName = composeSuiType(Bytes32.$typeName, ...typeArgs) as `${typeof PKG_V1}::bytes32::Bytes32`;
    ...
    static reified(): Bytes32Reified {
        return {
            ...
            fullTypeName: composeSuiType(Bytes32.$typeName, ...[]) as `${typeof PKG_V1}::bytes32::Bytes32`,
            typeArgs: [] as [],
