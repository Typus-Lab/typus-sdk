...
export class MessageTicket implements StructClass {
    ...
    private constructor(typeArgs: [], fields: MessageTicketFields) {
        this.$fullTypeName = composeSuiType(MessageTicket.$typeName, ...typeArgs) as `${typeof PKG_V1}::publish_message::MessageTicket`;
    ...
    static reified(): MessageTicketReified {
        return {
            ...
            fullTypeName: composeSuiType(MessageTicket.$typeName, ...[]) as `${typeof PKG_V1}::publish_message::MessageTicket`,
            typeArgs: [] as [],
...
export class WormholeMessage implements StructClass {
    ...
    private constructor(typeArgs: [], fields: WormholeMessageFields) {
        this.$fullTypeName = composeSuiType(WormholeMessage.$typeName, ...typeArgs) as `${typeof PKG_V1}::publish_message::WormholeMessage`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): WormholeMessageReified {
        return {
            ...
            fullTypeName: composeSuiType(WormholeMessage.$typeName, ...[]) as `${typeof PKG_V1}::publish_message::WormholeMessage`,
            typeArgs: [] as [],
