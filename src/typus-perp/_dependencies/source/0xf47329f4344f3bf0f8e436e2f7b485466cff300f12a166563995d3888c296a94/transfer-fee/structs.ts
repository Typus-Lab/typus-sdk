...
export class GovernanceWitness implements StructClass {
    ...
    static reified(): GovernanceWitnessReified {
        return {
            ...
            fullTypeName: composeSuiType(GovernanceWitness.$typeName, ...[]) as `${typeof PKG_V1}::transfer_fee::GovernanceWitness`,
            typeArgs: [] as [],
...
export class TransferFee implements StructClass {
    ...
    private constructor(typeArgs: [], fields: TransferFeeFields) {
        this.$fullTypeName = composeSuiType(TransferFee.$typeName, ...typeArgs) as `${typeof PKG_V1}::transfer_fee::TransferFee`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): TransferFeeReified {
        return {
            ...
            fullTypeName: composeSuiType(TransferFee.$typeName, ...[]) as `${typeof PKG_V1}::transfer_fee::TransferFee`,
            typeArgs: [] as [],
