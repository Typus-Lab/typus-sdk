...
export class GovernanceWitness implements StructClass {
    ...
    static reified(): GovernanceWitnessReified {
        return {
            ...
            fullTypeName: composeSuiType(GovernanceWitness.$typeName, ...[]) as `${typeof PKG_V1}::update_guardian_set::GovernanceWitness`,
            typeArgs: [] as [],
...
export class GuardianSetAdded implements StructClass {
    ...
    static reified(): GuardianSetAddedReified {
        return {
            ...
            fullTypeName: composeSuiType(GuardianSetAdded.$typeName, ...[]) as `${typeof PKG_V1}::update_guardian_set::GuardianSetAdded`,
            typeArgs: [] as [],
...
export class UpdateGuardianSet implements StructClass {
    ...
    static reified(): UpdateGuardianSetReified {
        return {
            ...
            fullTypeName: composeSuiType(UpdateGuardianSet.$typeName, ...[]) as `${typeof PKG_V1}::update_guardian_set::UpdateGuardianSet`,
            typeArgs: [] as [],
