...
export class Bytes20 implements StructClass {
    ...
    private constructor(typeArgs: [], fields: Bytes20Fields) {
        this.$fullTypeName = composeSuiType(Bytes20.$typeName, ...typeArgs) as `${typeof PKG_V1}::bytes20::Bytes20`;
    ...
    static reified(): Bytes20Reified {
        return {
            ...
            fullTypeName: composeSuiType(Bytes20.$typeName, ...[]) as `${typeof PKG_V1}::bytes20::Bytes20`,
            typeArgs: [] as [],
