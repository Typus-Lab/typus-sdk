...
export class ConsumedVAAs implements StructClass {
    ...
    private constructor(typeArgs: [], fields: ConsumedVAAsFields) {
        this.$fullTypeName = composeSuiType(ConsumedVAAs.$typeName, ...typeArgs) as `${typeof PKG_V1}::consumed_vaas::ConsumedVAAs`;
    ...
    static reified(): ConsumedVAAsReified {
        return {
            ...
            fullTypeName: composeSuiType(ConsumedVAAs.$typeName, ...[]) as `${typeof PKG_V1}::consumed_vaas::ConsumedVAAs`,
            typeArgs: [] as [],
