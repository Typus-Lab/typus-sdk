...
export class Coin<T extends PhantomTypeArgument> implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::coin::Coin`;
    ...
    private constructor(typeArgs: [PhantomToTypeStr<T>], fields: CoinFields<T>) {
        this.$fullTypeName = composeSuiType(Coin.$typeName, ...typeArgs) as `${typeof PKG_V26}::coin::Coin<${PhantomToTypeStr<T>}>`;
    ...
    static reified<T extends PhantomReified<PhantomTypeArgument>>(T: T): CoinReified<ToPhantomTypeArgument<T>> {
        return {
            ...
            fullTypeName: composeSuiType(
                Coin.$typeName,
                ...[extractType(T)]
            ) as `${typeof PKG_V26}::coin::Coin<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
...
export class CoinMetadata<T extends PhantomTypeArgument> implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::coin::CoinMetadata`;
    static readonly $numTypeParams = 1;
    static readonly $isPhantom = [true] as const;
    ...
    private constructor(typeArgs: [PhantomToTypeStr<T>], fields: CoinMetadataFields<T>) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V26}::coin::CoinMetadata<${PhantomToTypeStr<T>}>`;
        this.$typeArgs = typeArgs;
    ...
    static reified<T extends PhantomReified<PhantomTypeArgument>>(T: T): CoinMetadataReified<ToPhantomTypeArgument<T>> {
        return {
            ...
            fullTypeName: composeSuiType(
                CoinMetadata.$typeName,
                ...[extractType(T)]
            ) as `${typeof PKG_V26}::coin::CoinMetadata<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
            typeArgs: [extractType(T)] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>],
...
export class CurrencyCreated<T extends PhantomTypeArgument> implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::coin::CurrencyCreated`;
    static readonly $numTypeParams = 1;
    static readonly $isPhantom = [true] as const;
    ...
    private constructor(typeArgs: [PhantomToTypeStr<T>], fields: CurrencyCreatedFields<T>) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V26}::coin::CurrencyCreated<${PhantomToTypeStr<T>}>`;
        this.$typeArgs = typeArgs;
    ...
    static reified<T extends PhantomReified<PhantomTypeArgument>>(T: T): CurrencyCreatedReified<ToPhantomTypeArgument<T>> {
        return {
            ...
            fullTypeName: composeSuiType(
                CurrencyCreated.$typeName,
                ...[extractType(T)]
            ) as `${typeof PKG_V26}::coin::CurrencyCreated<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
            typeArgs: [extractType(T)] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>],
...
export class DenyCap<T extends PhantomTypeArgument> implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::coin::DenyCap`;
    static readonly $numTypeParams = 1;
    static readonly $isPhantom = [true] as const;
    ...
    private constructor(typeArgs: [PhantomToTypeStr<T>], fields: DenyCapFields<T>) {
        this.$fullTypeName = composeSuiType(DenyCap.$typeName, ...typeArgs) as `${typeof PKG_V26}::coin::DenyCap<${PhantomToTypeStr<T>}>`;
        this.$typeArgs = typeArgs;
    ...
    static reified<T extends PhantomReified<PhantomTypeArgument>>(T: T): DenyCapReified<ToPhantomTypeArgument<T>> {
        return {
            ...
            fullTypeName: composeSuiType(
                DenyCap.$typeName,
                ...[extractType(T)]
            ) as `${typeof PKG_V26}::coin::DenyCap<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
            typeArgs: [extractType(T)] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>],
...
export class DenyCapV2<T extends PhantomTypeArgument> implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::coin::DenyCapV2`;
    static readonly $numTypeParams = 1;
    static readonly $isPhantom = [true] as const;
    ...
    private constructor(typeArgs: [PhantomToTypeStr<T>], fields: DenyCapV2Fields<T>) {
        this.$fullTypeName = composeSuiType(
            DenyCapV2.$typeName,
            ...typeArgs
        ) as `${typeof PKG_V26}::coin::DenyCapV2<${PhantomToTypeStr<T>}>`;
        this.$typeArgs = typeArgs;
    ...
    static reified<T extends PhantomReified<PhantomTypeArgument>>(T: T): DenyCapV2Reified<ToPhantomTypeArgument<T>> {
        return {
            ...
            fullTypeName: composeSuiType(
                DenyCapV2.$typeName,
                ...[extractType(T)]
            ) as `${typeof PKG_V26}::coin::DenyCapV2<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
            typeArgs: [extractType(T)] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>],
...
export class RegulatedCoinMetadata<T extends PhantomTypeArgument> implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::coin::RegulatedCoinMetadata`;
    static readonly $numTypeParams = 1;
    static readonly $isPhantom = [true] as const;
    ...
    private constructor(typeArgs: [PhantomToTypeStr<T>], fields: RegulatedCoinMetadataFields<T>) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V26}::coin::RegulatedCoinMetadata<${PhantomToTypeStr<T>}>`;
        this.$typeArgs = typeArgs;
    ...
    static reified<T extends PhantomReified<PhantomTypeArgument>>(T: T): RegulatedCoinMetadataReified<ToPhantomTypeArgument<T>> {
        return {
            ...
            fullTypeName: composeSuiType(
                RegulatedCoinMetadata.$typeName,
                ...[extractType(T)]
            ) as `${typeof PKG_V26}::coin::RegulatedCoinMetadata<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
            typeArgs: [extractType(T)] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>],
...
export class TreasuryCap<T extends PhantomTypeArgument> implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::coin::TreasuryCap`;
    static readonly $numTypeParams = 1;
    static readonly $isPhantom = [true] as const;
    ...
    private constructor(typeArgs: [PhantomToTypeStr<T>], fields: TreasuryCapFields<T>) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V26}::coin::TreasuryCap<${PhantomToTypeStr<T>}>`;
        this.$typeArgs = typeArgs;
    ...
    static reified<T extends PhantomReified<PhantomTypeArgument>>(T: T): TreasuryCapReified<ToPhantomTypeArgument<T>> {
        return {
            ...
            fullTypeName: composeSuiType(
                TreasuryCap.$typeName,
                ...[extractType(T)]
            ) as `${typeof PKG_V26}::coin::TreasuryCap<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
            typeArgs: [extractType(T)] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>],
