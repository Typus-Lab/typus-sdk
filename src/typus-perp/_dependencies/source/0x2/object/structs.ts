...
export class ID implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::object::ID`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = ID.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::object::ID`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: IDFields) {
        this.$fullTypeName = composeSuiType(ID.$typeName, ...typeArgs) as `${typeof PKG_V26}::object::ID`;
    ...
    static reified(): IDReified {
        return {
            ...
            fullTypeName: composeSuiType(ID.$typeName, ...[]) as `${typeof PKG_V26}::object::ID`,
            typeArgs: [] as [],
...
export class UID implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::object::UID`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = UID.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::object::UID`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: UIDFields) {
        this.$fullTypeName = composeSuiType(UID.$typeName, ...typeArgs) as `${typeof PKG_V26}::object::UID`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): UIDReified {
        return {
            ...
            fullTypeName: composeSuiType(UID.$typeName, ...[]) as `${typeof PKG_V26}::object::UID`,
            typeArgs: [] as [],
