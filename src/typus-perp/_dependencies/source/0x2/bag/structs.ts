...
export class Bag implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::bag::Bag`;
    ...
    private constructor(typeArgs: [], fields: BagFields) {
        this.$fullTypeName = composeSuiType(Bag.$typeName, ...typeArgs) as `${typeof PKG_V26}::bag::Bag`;
    ...
    static reified(): BagReified {
        return {
            ...
            fullTypeName: composeSuiType(Bag.$typeName, ...[]) as `${typeof PKG_V26}::bag::Bag`,
            typeArgs: [] as [],
