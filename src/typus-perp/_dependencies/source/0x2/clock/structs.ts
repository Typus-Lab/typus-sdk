...
export class Clock implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::clock::Clock`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = Clock.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::clock::Clock`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: ClockFields) {
        this.$fullTypeName = composeSuiType(Clock.$typeName, ...typeArgs) as `${typeof PKG_V26}::clock::Clock`;
    ...
    static reified(): ClockReified {
        return {
            ...
            fullTypeName: composeSuiType(Clock.$typeName, ...[]) as `${typeof PKG_V26}::clock::Clock`,
            typeArgs: [] as [],
