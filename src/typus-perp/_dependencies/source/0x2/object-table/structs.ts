...
export function isObjectTable(type: string): boolean {
    ...
    return type.startsWith(`${PKG_V26}::object_table::ObjectTable` + "<");
}
...
export class ObjectTable<K extends PhantomTypeArgument, V extends PhantomTypeArgument> implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::object_table::ObjectTable`;
    static readonly $numTypeParams = 2;
    static readonly $isPhantom = [true, true] as const;

    readonly $typeName = ObjectTable.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::object_table::ObjectTable<${PhantomToTypeStr<K>}, ${PhantomToTypeStr<V>}>`;
    ...
    private constructor(typeArgs: [PhantomToTypeStr<K>, PhantomToTypeStr<V>], fields: ObjectTableFields<K, V>) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V26}::object_table::ObjectTable<${PhantomToTypeStr<K>}, ${PhantomToTypeStr<V>}>`;
    ...
    static reified<K extends PhantomReified<PhantomTypeArgument>, V extends PhantomReified<PhantomTypeArgument>>(
        ...
        return {
            ...
            ) as `${typeof PKG_V26}::object_table::ObjectTable<${PhantomToTypeStr<ToPhantomTypeArgument<K>>}, ${PhantomToTypeStr<ToPhantomTypeArgument<V>>}>`,
    ...
    static fromSuiObjectData<K extends PhantomReified<PhantomTypeArgument>, V extends PhantomReified<PhantomTypeArgument>>(
        typeArgs: [K, V],
        data: SuiObjectData
    ): ObjectTable<ToPhantomTypeArgument<K>, ToPhantomTypeArgument<V>> {
        if (data.bcs) {
