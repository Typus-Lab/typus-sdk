...
export class AddressKey implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::deny_list::AddressKey`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = AddressKey.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::deny_list::AddressKey`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: AddressKeyFields) {
        this.$fullTypeName = composeSuiType(AddressKey.$typeName, ...typeArgs) as `${typeof PKG_V26}::deny_list::AddressKey`;
    ...
    static reified(): AddressKeyReified {
        return {
            ...
            fullTypeName: composeSuiType(AddressKey.$typeName, ...[]) as `${typeof PKG_V26}::deny_list::AddressKey`,
            typeArgs: [] as [],
...
export class ConfigKey implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::deny_list::ConfigKey`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = ConfigKey.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::deny_list::ConfigKey`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: ConfigKeyFields) {
        this.$fullTypeName = composeSuiType(ConfigKey.$typeName, ...typeArgs) as `${typeof PKG_V26}::deny_list::ConfigKey`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): ConfigKeyReified {
        return {
            ...
            fullTypeName: composeSuiType(ConfigKey.$typeName, ...[]) as `${typeof PKG_V26}::deny_list::ConfigKey`,
            typeArgs: [] as [],
...
export class ConfigWriteCap implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::deny_list::ConfigWriteCap`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = ConfigWriteCap.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::deny_list::ConfigWriteCap`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: ConfigWriteCapFields) {
        this.$fullTypeName = composeSuiType(ConfigWriteCap.$typeName, ...typeArgs) as `${typeof PKG_V26}::deny_list::ConfigWriteCap`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): ConfigWriteCapReified {
        return {
            ...
            fullTypeName: composeSuiType(ConfigWriteCap.$typeName, ...[]) as `${typeof PKG_V26}::deny_list::ConfigWriteCap`,
            typeArgs: [] as [],
...
export class DenyList implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::deny_list::DenyList`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = DenyList.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::deny_list::DenyList`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: DenyListFields) {
        this.$fullTypeName = composeSuiType(DenyList.$typeName, ...typeArgs) as `${typeof PKG_V26}::deny_list::DenyList`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): DenyListReified {
        return {
            ...
            fullTypeName: composeSuiType(DenyList.$typeName, ...[]) as `${typeof PKG_V26}::deny_list::DenyList`,
            typeArgs: [] as [],
...
export class GlobalPauseKey implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::deny_list::GlobalPauseKey`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = GlobalPauseKey.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::deny_list::GlobalPauseKey`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: GlobalPauseKeyFields) {
        this.$fullTypeName = composeSuiType(GlobalPauseKey.$typeName, ...typeArgs) as `${typeof PKG_V26}::deny_list::GlobalPauseKey`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): GlobalPauseKeyReified {
        return {
            ...
            fullTypeName: composeSuiType(GlobalPauseKey.$typeName, ...[]) as `${typeof PKG_V26}::deny_list::GlobalPauseKey`,
            typeArgs: [] as [],
...
export class PerTypeConfigCreated implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::deny_list::PerTypeConfigCreated`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = PerTypeConfigCreated.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::deny_list::PerTypeConfigCreated`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: PerTypeConfigCreatedFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V26}::deny_list::PerTypeConfigCreated`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): PerTypeConfigCreatedReified {
        return {
            ...
            fullTypeName: composeSuiType(PerTypeConfigCreated.$typeName, ...[]) as `${typeof PKG_V26}::deny_list::PerTypeConfigCreated`,
            typeArgs: [] as [],
...
export class PerTypeList implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::deny_list::PerTypeList`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = PerTypeList.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::deny_list::PerTypeList`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: PerTypeListFields) {
        this.$fullTypeName = composeSuiType(PerTypeList.$typeName, ...typeArgs) as `${typeof PKG_V26}::deny_list::PerTypeList`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): PerTypeListReified {
        return {
            ...
            fullTypeName: composeSuiType(PerTypeList.$typeName, ...[]) as `${typeof PKG_V26}::deny_list::PerTypeList`,
            typeArgs: [] as [],
    ...
    static fromFields(fields: Record<string, any>): PerTypeList {
        return PerTypeList.reified().new({
            id: decodeFromFields(UID.reified(), fields.id),
            deniedCount: decodeFromFields(Table.reified(reified.phantom("address"), reified.phantom("u64")), fields.denied_count),
    ...
    static fromJSONField(field: any): PerTypeList {
        return PerTypeList.reified().new({
            id: decodeFromJSONField(UID.reified(), field.id),
            deniedCount: decodeFromJSONField(Table.reified(reified.phantom("address"), reified.phantom("u64")), field.deniedCount),
