...
export class Borrow implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::borrow::Borrow`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = Borrow.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::borrow::Borrow`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: BorrowFields) {
        this.$fullTypeName = composeSuiType(Borrow.$typeName, ...typeArgs) as `${typeof PKG_V26}::borrow::Borrow`;
    ...
    static reified(): BorrowReified {
        return {
            ...
            fullTypeName: composeSuiType(Borrow.$typeName, ...[]) as `${typeof PKG_V26}::borrow::Borrow`,
            typeArgs: [] as [],
...
export class Referent<T extends TypeArgument> implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::borrow::Referent`;
    static readonly $numTypeParams = 1;
    static readonly $isPhantom = [false] as const;

    readonly $typeName = Referent.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::borrow::Referent<${ToTypeStr<T>}>`;
    ...
    private constructor(typeArgs: [ToTypeStr<T>], fields: ReferentFields<T>) {
        this.$fullTypeName = composeSuiType(Referent.$typeName, ...typeArgs) as `${typeof PKG_V26}::borrow::Referent<${ToTypeStr<T>}>`;
        this.$typeArgs = typeArgs;
    ...
    static reified<T extends Reified<TypeArgument, any>>(T: T): ReferentReified<ToTypeArgument<T>> {
        return {
            ...
            fullTypeName: composeSuiType(
                Referent.$typeName,
                ...[extractType(T)]
            ) as `${typeof PKG_V26}::borrow::Referent<${ToTypeStr<ToTypeArgument<T>>}>`,
