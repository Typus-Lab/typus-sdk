...
export class Url implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::url::Url`;
    ...
    private constructor(typeArgs: [], fields: UrlFields) {
        this.$fullTypeName = composeSuiType(Url.$typeName, ...typeArgs) as `${typeof PKG_V26}::url::Url`;
    ...
    static reified(): UrlReified {
        return {
            ...
            fullTypeName: composeSuiType(Url.$typeName, ...[]) as `${typeof PKG_V26}::url::Url`,
            typeArgs: [] as [],
