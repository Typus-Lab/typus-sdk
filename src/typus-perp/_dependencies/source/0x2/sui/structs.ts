...
export class SUI implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::sui::SUI`;
    ...
    private constructor(typeArgs: [], fields: SUIFields) {
        this.$fullTypeName = composeSuiType(SUI.$typeName, ...typeArgs) as `${typeof PKG_V26}::sui::SUI`;
    ...
    static reified(): SUIReified {
        return {
            ...
            fullTypeName: composeSuiType(SUI.$typeName, ...[]) as `${typeof PKG_V26}::sui::SUI`,
            typeArgs: [] as [],
