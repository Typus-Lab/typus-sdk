...
export class VerifiedID implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::zklogin_verified_id::VerifiedID`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = VerifiedID.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::zklogin_verified_id::VerifiedID`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: VerifiedIDFields) {
        this.$fullTypeName = composeSuiType(VerifiedID.$typeName, ...typeArgs) as `${typeof PKG_V26}::zklogin_verified_id::VerifiedID`;
    ...
    static reified(): VerifiedIDReified {
        return {
            ...
            fullTypeName: composeSuiType(VerifiedID.$typeName, ...[]) as `${typeof PKG_V26}::zklogin_verified_id::VerifiedID`,
            typeArgs: [] as [],
