...
export class Display<T extends PhantomTypeArgument> implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::display::Display`;
    static readonly $numTypeParams = 1;
    static readonly $isPhantom = [true] as const;

    readonly $typeName = Display.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::display::Display<${PhantomToTypeStr<T>}>`;
    ...
    private constructor(typeArgs: [PhantomToTypeStr<T>], fields: DisplayFields<T>) {
        this.$fullTypeName = composeSuiType(
            Display.$typeName,
            ...typeArgs
        ) as `${typeof PKG_V26}::display::Display<${PhantomToTypeStr<T>}>`;
    ...
    static reified<T extends PhantomReified<PhantomTypeArgument>>(T: T): DisplayReified<ToPhantomTypeArgument<T>> {
        return {
            ...
            fullTypeName: composeSuiType(
                Display.$typeName,
                ...[extractType(T)]
            ) as `${typeof PKG_V26}::display::Display<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
...
export class DisplayCreated<T extends PhantomTypeArgument> implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::display::DisplayCreated`;
    static readonly $numTypeParams = 1;
    static readonly $isPhantom = [true] as const;

    readonly $typeName = DisplayCreated.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::display::DisplayCreated<${PhantomToTypeStr<T>}>`;
    readonly $typeArgs: [PhantomToTypeStr<T>];
    ...
    private constructor(typeArgs: [PhantomToTypeStr<T>], fields: DisplayCreatedFields<T>) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V26}::display::DisplayCreated<${PhantomToTypeStr<T>}>`;
        this.$typeArgs = typeArgs;
    ...
    static reified<T extends PhantomReified<PhantomTypeArgument>>(T: T): DisplayCreatedReified<ToPhantomTypeArgument<T>> {
        return {
            ...
            fullTypeName: composeSuiType(
                DisplayCreated.$typeName,
                ...[extractType(T)]
            ) as `${typeof PKG_V26}::display::DisplayCreated<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
            typeArgs: [extractType(T)] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>],
    ...
    static fromJSON<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        assertReifiedTypeArgsMatch(composeSuiType(DisplayCreated.$typeName, extractType(typeArg)), json.$typeArgs, [typeArg]);
...
export class VersionUpdated<T extends PhantomTypeArgument> implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::display::VersionUpdated`;
    static readonly $numTypeParams = 1;
    static readonly $isPhantom = [true] as const;

    readonly $typeName = VersionUpdated.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::display::VersionUpdated<${PhantomToTypeStr<T>}>`;
    readonly $typeArgs: [PhantomToTypeStr<T>];
    ...
    private constructor(typeArgs: [PhantomToTypeStr<T>], fields: VersionUpdatedFields<T>) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V26}::display::VersionUpdated<${PhantomToTypeStr<T>}>`;
        this.$typeArgs = typeArgs;
    ...
    static reified<T extends PhantomReified<PhantomTypeArgument>>(T: T): VersionUpdatedReified<ToPhantomTypeArgument<T>> {
        return {
            ...
            fullTypeName: composeSuiType(
                VersionUpdated.$typeName,
                ...[extractType(T)]
            ) as `${typeof PKG_V26}::display::VersionUpdated<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
            typeArgs: [extractType(T)] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>],
    ...
    static fromJSON<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        assertReifiedTypeArgsMatch(composeSuiType(VersionUpdated.$typeName, extractType(typeArg)), json.$typeArgs, [typeArg]);
