...
export class Random implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::random::Random`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = Random.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::random::Random`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: RandomFields) {
        this.$fullTypeName = composeSuiType(Random.$typeName, ...typeArgs) as `${typeof PKG_V26}::random::Random`;
    ...
    static reified(): RandomReified {
        return {
            ...
            fullTypeName: composeSuiType(Random.$typeName, ...[]) as `${typeof PKG_V26}::random::Random`,
            typeArgs: [] as [],
...
export class RandomGenerator implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::random::RandomGenerator`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = RandomGenerator.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::random::RandomGenerator`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: RandomGeneratorFields) {
        this.$fullTypeName = composeSuiType(RandomGenerator.$typeName, ...typeArgs) as `${typeof PKG_V26}::random::RandomGenerator`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): RandomGeneratorReified {
        return {
            ...
            fullTypeName: composeSuiType(RandomGenerator.$typeName, ...[]) as `${typeof PKG_V26}::random::RandomGenerator`,
            typeArgs: [] as [],
...
export class RandomInner implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::random::RandomInner`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = RandomInner.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::random::RandomInner`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: RandomInnerFields) {
        this.$fullTypeName = composeSuiType(RandomInner.$typeName, ...typeArgs) as `${typeof PKG_V26}::random::RandomInner`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): RandomInnerReified {
        return {
            ...
            fullTypeName: composeSuiType(RandomInner.$typeName, ...[]) as `${typeof PKG_V26}::random::RandomInner`,
            typeArgs: [] as [],
