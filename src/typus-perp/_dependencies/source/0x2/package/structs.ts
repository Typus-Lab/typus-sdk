...
export class Publisher implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::package::Publisher`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = Publisher.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::package::Publisher`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: PublisherFields) {
        this.$fullTypeName = composeSuiType(Publisher.$typeName, ...typeArgs) as `${typeof PKG_V26}::package::Publisher`;
    ...
    static reified(): PublisherReified {
        return {
            ...
            fullTypeName: composeSuiType(Publisher.$typeName, ...[]) as `${typeof PKG_V26}::package::Publisher`,
            typeArgs: [] as [],
...
export class UpgradeCap implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::package::UpgradeCap`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = UpgradeCap.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::package::UpgradeCap`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: UpgradeCapFields) {
        this.$fullTypeName = composeSuiType(UpgradeCap.$typeName, ...typeArgs) as `${typeof PKG_V26}::package::UpgradeCap`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): UpgradeCapReified {
        return {
            ...
            fullTypeName: composeSuiType(UpgradeCap.$typeName, ...[]) as `${typeof PKG_V26}::package::UpgradeCap`,
            typeArgs: [] as [],
...
export class UpgradeReceipt implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::package::UpgradeReceipt`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = UpgradeReceipt.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::package::UpgradeReceipt`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: UpgradeReceiptFields) {
        this.$fullTypeName = composeSuiType(UpgradeReceipt.$typeName, ...typeArgs) as `${typeof PKG_V26}::package::UpgradeReceipt`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): UpgradeReceiptReified {
        return {
            ...
            fullTypeName: composeSuiType(UpgradeReceipt.$typeName, ...[]) as `${typeof PKG_V26}::package::UpgradeReceipt`,
            typeArgs: [] as [],
...
export class UpgradeTicket implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::package::UpgradeTicket`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = UpgradeTicket.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::package::UpgradeTicket`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: UpgradeTicketFields) {
        this.$fullTypeName = composeSuiType(UpgradeTicket.$typeName, ...typeArgs) as `${typeof PKG_V26}::package::UpgradeTicket`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): UpgradeTicketReified {
        return {
            ...
            fullTypeName: composeSuiType(UpgradeTicket.$typeName, ...[]) as `${typeof PKG_V26}::package::UpgradeTicket`,
            typeArgs: [] as [],
