...
export class VersionChangeCap implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::versioned::VersionChangeCap`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = VersionChangeCap.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::versioned::VersionChangeCap`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: VersionChangeCapFields) {
        this.$fullTypeName = composeSuiType(VersionChangeCap.$typeName, ...typeArgs) as `${typeof PKG_V26}::versioned::VersionChangeCap`;
    ...
    static reified(): VersionChangeCapReified {
        return {
            ...
            fullTypeName: composeSuiType(VersionChangeCap.$typeName, ...[]) as `${typeof PKG_V26}::versioned::VersionChangeCap`,
            typeArgs: [] as [],
...
export class Versioned implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::versioned::Versioned`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = Versioned.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::versioned::Versioned`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: VersionedFields) {
        this.$fullTypeName = composeSuiType(Versioned.$typeName, ...typeArgs) as `${typeof PKG_V26}::versioned::Versioned`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): VersionedReified {
        return {
            ...
            fullTypeName: composeSuiType(Versioned.$typeName, ...[]) as `${typeof PKG_V26}::versioned::Versioned`,
            typeArgs: [] as [],
