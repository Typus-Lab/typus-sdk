...
export class Field<Name extends TypeArgument, Value extends TypeArgument> implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::dynamic_field::Field`;
    static readonly $numTypeParams = 2;
    static readonly $isPhantom = [false, false] as const;

    readonly $typeName = Field.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::dynamic_field::Field<${ToTypeStr<Name>}, ${ToTypeStr<Value>}>`;
    ...
    private constructor(typeArgs: [ToTypeStr<Name>, ToTypeStr<Value>], fields: FieldFields<Name, Value>) {
        this.$fullTypeName = composeSuiType(
            Field.$typeName,
            ...typeArgs
        ) as `${typeof PKG_V26}::dynamic_field::Field<${ToTypeStr<Name>}, ${ToTypeStr<Value>}>`;
    ...
    static reified<Name extends Reified<TypeArgument, any>, Value extends Reified<TypeArgument, any>>(
        ...
        return {
            ...
            ) as `${typeof PKG_V26}::dynamic_field::Field<${ToTypeStr<ToTypeArgument<Name>>}, ${ToTypeStr<ToTypeArgument<Value>>}>`,
            typeArgs: [extractType(Name), extractType(Value)] as [ToTypeStr<ToTypeArgument<Name>>, ToTypeStr<ToTypeArgument<Value>>],
