...
export class Curve implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::groth16::Curve`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = Curve.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::groth16::Curve`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: CurveFields) {
        this.$fullTypeName = composeSuiType(Curve.$typeName, ...typeArgs) as `${typeof PKG_V26}::groth16::Curve`;
    ...
    static reified(): CurveReified {
        return {
            ...
            fullTypeName: composeSuiType(Curve.$typeName, ...[]) as `${typeof PKG_V26}::groth16::Curve`,
            typeArgs: [] as [],
...
export class PreparedVerifyingKey implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::groth16::PreparedVerifyingKey`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = PreparedVerifyingKey.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::groth16::PreparedVerifyingKey`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: PreparedVerifyingKeyFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V26}::groth16::PreparedVerifyingKey`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): PreparedVerifyingKeyReified {
        return {
            ...
            fullTypeName: composeSuiType(PreparedVerifyingKey.$typeName, ...[]) as `${typeof PKG_V26}::groth16::PreparedVerifyingKey`,
            typeArgs: [] as [],
...
export class ProofPoints implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::groth16::ProofPoints`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = ProofPoints.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::groth16::ProofPoints`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: ProofPointsFields) {
        this.$fullTypeName = composeSuiType(ProofPoints.$typeName, ...typeArgs) as `${typeof PKG_V26}::groth16::ProofPoints`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): ProofPointsReified {
        return {
            ...
            fullTypeName: composeSuiType(ProofPoints.$typeName, ...[]) as `${typeof PKG_V26}::groth16::ProofPoints`,
            typeArgs: [] as [],
...
export class PublicProofInputs implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::groth16::PublicProofInputs`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = PublicProofInputs.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::groth16::PublicProofInputs`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: PublicProofInputsFields) {
        this.$fullTypeName = composeSuiType(PublicProofInputs.$typeName, ...typeArgs) as `${typeof PKG_V26}::groth16::PublicProofInputs`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): PublicProofInputsReified {
        return {
            ...
            fullTypeName: composeSuiType(PublicProofInputs.$typeName, ...[]) as `${typeof PKG_V26}::groth16::PublicProofInputs`,
            typeArgs: [] as [],
