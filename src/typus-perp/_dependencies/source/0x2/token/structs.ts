...
export class RuleKey<T extends PhantomTypeArgument> implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::token::RuleKey`;
    ...
    private constructor(typeArgs: [PhantomToTypeStr<T>], fields: RuleKeyFields<T>) {
        this.$fullTypeName = composeSuiType(RuleKey.$typeName, ...typeArgs) as `${typeof PKG_V26}::token::RuleKey<${PhantomToTypeStr<T>}>`;
    ...
    static reified<T extends PhantomReified<PhantomTypeArgument>>(T: T): RuleKeyReified<ToPhantomTypeArgument<T>> {
        return {
            ...
            fullTypeName: composeSuiType(
                RuleKey.$typeName,
                ...[extractType(T)]
            ) as `${typeof PKG_V26}::token::RuleKey<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
...
export class ActionRequest<T extends PhantomTypeArgument> implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::token::ActionRequest`;
    static readonly $numTypeParams = 1;
    static readonly $isPhantom = [true] as const;
    ...
    private constructor(typeArgs: [PhantomToTypeStr<T>], fields: ActionRequestFields<T>) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V26}::token::ActionRequest<${PhantomToTypeStr<T>}>`;
        this.$typeArgs = typeArgs;
    ...
    static reified<T extends PhantomReified<PhantomTypeArgument>>(T: T): ActionRequestReified<ToPhantomTypeArgument<T>> {
        return {
            ...
            fullTypeName: composeSuiType(
                ActionRequest.$typeName,
                ...[extractType(T)]
            ) as `${typeof PKG_V26}::token::ActionRequest<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
            typeArgs: [extractType(T)] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>],
    ...
    static fromJSON<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        assertReifiedTypeArgsMatch(composeSuiType(ActionRequest.$typeName, extractType(typeArg)), json.$typeArgs, [typeArg]);
...
export class Token<T extends PhantomTypeArgument> implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::token::Token`;
    static readonly $numTypeParams = 1;
    static readonly $isPhantom = [true] as const;
    ...
    private constructor(typeArgs: [PhantomToTypeStr<T>], fields: TokenFields<T>) {
        this.$fullTypeName = composeSuiType(Token.$typeName, ...typeArgs) as `${typeof PKG_V26}::token::Token<${PhantomToTypeStr<T>}>`;
        this.$typeArgs = typeArgs;
    ...
    static reified<T extends PhantomReified<PhantomTypeArgument>>(T: T): TokenReified<ToPhantomTypeArgument<T>> {
        return {
            ...
            fullTypeName: composeSuiType(
                Token.$typeName,
                ...[extractType(T)]
            ) as `${typeof PKG_V26}::token::Token<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
            typeArgs: [extractType(T)] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>],
...
export class TokenPolicy<T extends PhantomTypeArgument> implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::token::TokenPolicy`;
    static readonly $numTypeParams = 1;
    static readonly $isPhantom = [true] as const;
    ...
    private constructor(typeArgs: [PhantomToTypeStr<T>], fields: TokenPolicyFields<T>) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V26}::token::TokenPolicy<${PhantomToTypeStr<T>}>`;
        this.$typeArgs = typeArgs;
    ...
    static reified<T extends PhantomReified<PhantomTypeArgument>>(T: T): TokenPolicyReified<ToPhantomTypeArgument<T>> {
        return {
            ...
            fullTypeName: composeSuiType(
                TokenPolicy.$typeName,
                ...[extractType(T)]
            ) as `${typeof PKG_V26}::token::TokenPolicy<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
            typeArgs: [extractType(T)] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>],
    ...
    static fromFieldsWithTypes<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return TokenPolicy.reified(typeArg).new({
            ...
            rules: decodeFromFieldsWithTypes(VecMap.reified(String.reified(), VecSet.reified(TypeName.reified())), item.fields.rules),
        });
    }
...
export class TokenPolicyCap<T extends PhantomTypeArgument> implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::token::TokenPolicyCap`;
    static readonly $numTypeParams = 1;
    static readonly $isPhantom = [true] as const;
    ...
    private constructor(typeArgs: [PhantomToTypeStr<T>], fields: TokenPolicyCapFields<T>) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V26}::token::TokenPolicyCap<${PhantomToTypeStr<T>}>`;
        this.$typeArgs = typeArgs;
    ...
    static reified<T extends PhantomReified<PhantomTypeArgument>>(T: T): TokenPolicyCapReified<ToPhantomTypeArgument<T>> {
        return {
            ...
            fullTypeName: composeSuiType(
                TokenPolicyCap.$typeName,
                ...[extractType(T)]
            ) as `${typeof PKG_V26}::token::TokenPolicyCap<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
            typeArgs: [extractType(T)] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>],
    ...
    static fromJSON<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        assertReifiedTypeArgsMatch(composeSuiType(TokenPolicyCap.$typeName, extractType(typeArg)), json.$typeArgs, [typeArg]);
...
export class TokenPolicyCreated<T extends PhantomTypeArgument> implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::token::TokenPolicyCreated`;
    static readonly $numTypeParams = 1;
    static readonly $isPhantom = [true] as const;
    ...
    private constructor(typeArgs: [PhantomToTypeStr<T>], fields: TokenPolicyCreatedFields<T>) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V26}::token::TokenPolicyCreated<${PhantomToTypeStr<T>}>`;
        this.$typeArgs = typeArgs;
    ...
    static reified<T extends PhantomReified<PhantomTypeArgument>>(T: T): TokenPolicyCreatedReified<ToPhantomTypeArgument<T>> {
        return {
            ...
            fullTypeName: composeSuiType(
                TokenPolicyCreated.$typeName,
                ...[extractType(T)]
            ) as `${typeof PKG_V26}::token::TokenPolicyCreated<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
            typeArgs: [extractType(T)] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>],
    ...
    static fromJSON<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        assertReifiedTypeArgsMatch(composeSuiType(TokenPolicyCreated.$typeName, extractType(typeArg)), json.$typeArgs, [typeArg]);
