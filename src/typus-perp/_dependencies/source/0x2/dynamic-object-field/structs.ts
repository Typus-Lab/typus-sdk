...
export class Wrapper<Name extends TypeArgument> implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::dynamic_object_field::Wrapper`;
    static readonly $numTypeParams = 1;
    static readonly $isPhantom = [false] as const;

    readonly $typeName = Wrapper.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::dynamic_object_field::Wrapper<${ToTypeStr<Name>}>`;
    ...
    private constructor(typeArgs: [ToTypeStr<Name>], fields: WrapperFields<Name>) {
        this.$fullTypeName = composeSuiType(
            Wrapper.$typeName,
            ...typeArgs
        ) as `${typeof PKG_V26}::dynamic_object_field::Wrapper<${ToTypeStr<Name>}>`;
    ...
    static reified<Name extends Reified<TypeArgument, any>>(Name: Name): WrapperReified<ToTypeArgument<Name>> {
        return {
            ...
            fullTypeName: composeSuiType(
                Wrapper.$typeName,
                ...[extractType(Name)]
            ) as `${typeof PKG_V26}::dynamic_object_field::Wrapper<${ToTypeStr<ToTypeArgument<Name>>}>`,
