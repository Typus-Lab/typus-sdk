...
export class ActiveJwk implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::authenticator_state::ActiveJwk`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = ActiveJwk.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::authenticator_state::ActiveJwk`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: ActiveJwkFields) {
        this.$fullTypeName = composeSuiType(ActiveJwk.$typeName, ...typeArgs) as `${typeof PKG_V26}::authenticator_state::ActiveJwk`;
    ...
    static reified(): ActiveJwkReified {
        return {
            ...
            fullTypeName: composeSuiType(ActiveJwk.$typeName, ...[]) as `${typeof PKG_V26}::authenticator_state::ActiveJwk`,
            typeArgs: [] as [],
...
export class AuthenticatorState implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::authenticator_state::AuthenticatorState`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = AuthenticatorState.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::authenticator_state::AuthenticatorState`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: AuthenticatorStateFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V26}::authenticator_state::AuthenticatorState`;
        this.$typeArgs = typeArgs;
...
export class AuthenticatorStateInner implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::authenticator_state::AuthenticatorStateInner`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = AuthenticatorStateInner.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::authenticator_state::AuthenticatorStateInner`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: AuthenticatorStateInnerFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V26}::authenticator_state::AuthenticatorStateInner`;
        this.$typeArgs = typeArgs;
...
export class JWK implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::authenticator_state::JWK`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = JWK.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::authenticator_state::JWK`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: JWKFields) {
        this.$fullTypeName = composeSuiType(JWK.$typeName, ...typeArgs) as `${typeof PKG_V26}::authenticator_state::JWK`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): JWKReified {
        return {
            ...
            fullTypeName: composeSuiType(JWK.$typeName, ...[]) as `${typeof PKG_V26}::authenticator_state::JWK`,
            typeArgs: [] as [],
...
export class JwkId implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::authenticator_state::JwkId`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = JwkId.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::authenticator_state::JwkId`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: JwkIdFields) {
        this.$fullTypeName = composeSuiType(JwkId.$typeName, ...typeArgs) as `${typeof PKG_V26}::authenticator_state::JwkId`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): JwkIdReified {
        return {
            ...
            fullTypeName: composeSuiType(JwkId.$typeName, ...[]) as `${typeof PKG_V26}::authenticator_state::JwkId`,
            typeArgs: [] as [],
