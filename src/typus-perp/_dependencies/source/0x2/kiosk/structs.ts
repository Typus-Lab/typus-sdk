...
export class Borrow implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::kiosk::Borrow`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = Borrow.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::kiosk::Borrow`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: BorrowFields) {
        this.$fullTypeName = composeSuiType(Borrow.$typeName, ...typeArgs) as `${typeof PKG_V26}::kiosk::Borrow`;
    ...
    static reified(): BorrowReified {
        return {
            ...
            fullTypeName: composeSuiType(Borrow.$typeName, ...[]) as `${typeof PKG_V26}::kiosk::Borrow`,
            typeArgs: [] as [],
...
export class Item implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::kiosk::Item`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = Item.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::kiosk::Item`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: ItemFields) {
        this.$fullTypeName = composeSuiType(Item.$typeName, ...typeArgs) as `${typeof PKG_V26}::kiosk::Item`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): ItemReified {
        return {
            ...
            fullTypeName: composeSuiType(Item.$typeName, ...[]) as `${typeof PKG_V26}::kiosk::Item`,
            typeArgs: [] as [],
...
export class ItemDelisted<T extends PhantomTypeArgument> implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::kiosk::ItemDelisted`;
    static readonly $numTypeParams = 1;
    static readonly $isPhantom = [true] as const;

    readonly $typeName = ItemDelisted.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::kiosk::ItemDelisted<${PhantomToTypeStr<T>}>`;
    ...
    private constructor(typeArgs: [PhantomToTypeStr<T>], fields: ItemDelistedFields<T>) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V26}::kiosk::ItemDelisted<${PhantomToTypeStr<T>}>`;
        this.$typeArgs = typeArgs;
    ...
    static reified<T extends PhantomReified<PhantomTypeArgument>>(T: T): ItemDelistedReified<ToPhantomTypeArgument<T>> {
        return {
            ...
            fullTypeName: composeSuiType(
                ItemDelisted.$typeName,
                ...[extractType(T)]
            ) as `${typeof PKG_V26}::kiosk::ItemDelisted<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
...
export class ItemListed<T extends PhantomTypeArgument> implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::kiosk::ItemListed`;
    static readonly $numTypeParams = 1;
    static readonly $isPhantom = [true] as const;

    readonly $typeName = ItemListed.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::kiosk::ItemListed<${PhantomToTypeStr<T>}>`;
    readonly $typeArgs: [PhantomToTypeStr<T>];
    ...
    private constructor(typeArgs: [PhantomToTypeStr<T>], fields: ItemListedFields<T>) {
        this.$fullTypeName = composeSuiType(
            ItemListed.$typeName,
            ...typeArgs
        ) as `${typeof PKG_V26}::kiosk::ItemListed<${PhantomToTypeStr<T>}>`;
        this.$typeArgs = typeArgs;
    ...
    static reified<T extends PhantomReified<PhantomTypeArgument>>(T: T): ItemListedReified<ToPhantomTypeArgument<T>> {
        return {
            ...
            fullTypeName: composeSuiType(
                ItemListed.$typeName,
                ...[extractType(T)]
            ) as `${typeof PKG_V26}::kiosk::ItemListed<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
            typeArgs: [extractType(T)] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>],
...
export class ItemPurchased<T extends PhantomTypeArgument> implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::kiosk::ItemPurchased`;
    static readonly $numTypeParams = 1;
    static readonly $isPhantom = [true] as const;

    readonly $typeName = ItemPurchased.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::kiosk::ItemPurchased<${PhantomToTypeStr<T>}>`;
    readonly $typeArgs: [PhantomToTypeStr<T>];
    ...
    private constructor(typeArgs: [PhantomToTypeStr<T>], fields: ItemPurchasedFields<T>) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V26}::kiosk::ItemPurchased<${PhantomToTypeStr<T>}>`;
        this.$typeArgs = typeArgs;
    ...
    static reified<T extends PhantomReified<PhantomTypeArgument>>(T: T): ItemPurchasedReified<ToPhantomTypeArgument<T>> {
        return {
            ...
            fullTypeName: composeSuiType(
                ItemPurchased.$typeName,
                ...[extractType(T)]
            ) as `${typeof PKG_V26}::kiosk::ItemPurchased<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
            typeArgs: [extractType(T)] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>],
    ...
    static fromJSON<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        assertReifiedTypeArgsMatch(composeSuiType(ItemPurchased.$typeName, extractType(typeArg)), json.$typeArgs, [typeArg]);
...
export class Kiosk implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::kiosk::Kiosk`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = Kiosk.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::kiosk::Kiosk`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: KioskFields) {
        this.$fullTypeName = composeSuiType(Kiosk.$typeName, ...typeArgs) as `${typeof PKG_V26}::kiosk::Kiosk`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): KioskReified {
        return {
            ...
            fullTypeName: composeSuiType(Kiosk.$typeName, ...[]) as `${typeof PKG_V26}::kiosk::Kiosk`,
            typeArgs: [] as [],
...
export class KioskOwnerCap implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::kiosk::KioskOwnerCap`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = KioskOwnerCap.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::kiosk::KioskOwnerCap`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: KioskOwnerCapFields) {
        this.$fullTypeName = composeSuiType(KioskOwnerCap.$typeName, ...typeArgs) as `${typeof PKG_V26}::kiosk::KioskOwnerCap`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): KioskOwnerCapReified {
        return {
            ...
            fullTypeName: composeSuiType(KioskOwnerCap.$typeName, ...[]) as `${typeof PKG_V26}::kiosk::KioskOwnerCap`,
            typeArgs: [] as [],
...
export class Listing implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::kiosk::Listing`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = Listing.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::kiosk::Listing`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: ListingFields) {
        this.$fullTypeName = composeSuiType(Listing.$typeName, ...typeArgs) as `${typeof PKG_V26}::kiosk::Listing`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): ListingReified {
        return {
            ...
            fullTypeName: composeSuiType(Listing.$typeName, ...[]) as `${typeof PKG_V26}::kiosk::Listing`,
            typeArgs: [] as [],
...
export class Lock implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::kiosk::Lock`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = Lock.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::kiosk::Lock`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: LockFields) {
        this.$fullTypeName = composeSuiType(Lock.$typeName, ...typeArgs) as `${typeof PKG_V26}::kiosk::Lock`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): LockReified {
        return {
            ...
            fullTypeName: composeSuiType(Lock.$typeName, ...[]) as `${typeof PKG_V26}::kiosk::Lock`,
            typeArgs: [] as [],
...
export class PurchaseCap<T extends PhantomTypeArgument> implements StructClass {
    ...
    static readonly $typeName = `${PKG_V26}::kiosk::PurchaseCap`;
    static readonly $numTypeParams = 1;
    static readonly $isPhantom = [true] as const;

    readonly $typeName = PurchaseCap.$typeName;
    readonly $fullTypeName: `${typeof PKG_V26}::kiosk::PurchaseCap<${PhantomToTypeStr<T>}>`;
    readonly $typeArgs: [PhantomToTypeStr<T>];
    ...
    private constructor(typeArgs: [PhantomToTypeStr<T>], fields: PurchaseCapFields<T>) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V26}::kiosk::PurchaseCap<${PhantomToTypeStr<T>}>`;
        this.$typeArgs = typeArgs;
    ...
    static reified<T extends PhantomReified<PhantomTypeArgument>>(T: T): PurchaseCapReified<ToPhantomTypeArgument<T>> {
        return {
            ...
            fullTypeName: composeSuiType(
                PurchaseCap.$typeName,
                ...[extractType(T)]
            ) as `${typeof PKG_V26}::kiosk::PurchaseCap<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
            typeArgs: [extractType(T)] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>],
