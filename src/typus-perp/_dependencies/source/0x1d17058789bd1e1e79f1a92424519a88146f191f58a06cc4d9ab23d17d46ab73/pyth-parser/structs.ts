...
export function isPythPrice(type: string): boolean {
    ...
    return type === `${PKG_V1}::pyth_parser::PythPrice`;
}
...
export class PythPrice implements StructClass {
    ...
    static readonly $typeName = `${PKG_V1}::pyth_parser::PythPrice`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = PythPrice.$typeName;
    readonly $fullTypeName: `${typeof PKG_V1}::pyth_parser::PythPrice`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: PythPriceFields) {
        this.$fullTypeName = composeSuiType(PythPrice.$typeName, ...typeArgs) as `${typeof PKG_V1}::pyth_parser::PythPrice`;
    ...
    static reified(): PythPriceReified {
        return {
            ...
            fullTypeName: composeSuiType(PythPrice.$typeName, ...[]) as `${typeof PKG_V1}::pyth_parser::PythPrice`,
            typeArgs: [] as [],
...
export function isPythPriceInfoObject(type: string): boolean {
    type = compressSuiType(type);
    return type === `${PKG_V1}::pyth_parser::PythPriceInfoObject`;
}
...
export class PythPriceInfoObject implements StructClass {
    ...
    static readonly $typeName = `${PKG_V1}::pyth_parser::PythPriceInfoObject`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = PythPriceInfoObject.$typeName;
    readonly $fullTypeName: `${typeof PKG_V1}::pyth_parser::PythPriceInfoObject`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: PythPriceInfoObjectFields) {
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V1}::pyth_parser::PythPriceInfoObject`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): PythPriceInfoObjectReified {
        return {
            ...
            fullTypeName: composeSuiType(PythPriceInfoObject.$typeName, ...[]) as `${typeof PKG_V1}::pyth_parser::PythPriceInfoObject`,
            typeArgs: [] as [],
