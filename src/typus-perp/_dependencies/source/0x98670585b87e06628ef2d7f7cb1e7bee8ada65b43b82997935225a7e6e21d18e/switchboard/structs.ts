...
export class AdminCap implements StructClass {
    ...
    private constructor(typeArgs: [], fields: AdminCapFields) {
        this.$fullTypeName = composeSuiType(AdminCap.$typeName, ...typeArgs) as `${typeof PKG_V1}::switchboard::AdminCap`;
    ...
    static reified(): AdminCapReified {
        return {
            ...
            fullTypeName: composeSuiType(AdminCap.$typeName, ...[]) as `${typeof PKG_V1}::switchboard::AdminCap`,
            typeArgs: [] as [],
