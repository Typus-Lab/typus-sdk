...
export class MigrateComplete implements StructClass {
    ...
    private constructor(typeArgs: [], fields: MigrateCompleteFields) {
        this.$fullTypeName = composeSuiType(MigrateComplete.$typeName, ...typeArgs) as `${typeof PKG_V1}::migrate::MigrateComplete`;
    ...
    static reified(): MigrateCompleteReified {
        return {
            ...
            fullTypeName: composeSuiType(MigrateComplete.$typeName, ...[]) as `${typeof PKG_V1}::migrate::MigrateComplete`,
            typeArgs: [] as [],
