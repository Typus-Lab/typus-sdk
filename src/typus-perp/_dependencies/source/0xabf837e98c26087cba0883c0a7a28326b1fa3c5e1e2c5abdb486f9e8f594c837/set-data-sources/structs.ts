...
export class DataSources implements StructClass {
    ...
    private constructor(typeArgs: [], fields: DataSourcesFields) {
        this.$fullTypeName = composeSuiType(DataSources.$typeName, ...typeArgs) as `${typeof PKG_V1}::set_data_sources::DataSources`;
    ...
    static reified(): DataSourcesReified {
        return {
            ...
            fullTypeName: composeSuiType(DataSources.$typeName, ...[]) as `${typeof PKG_V1}::set_data_sources::DataSources`,
            typeArgs: [] as [],
