...
import { ExternalAddress } from "../../0xf47329f4344f3bf0f8e436e2f7b485466cff300f12a166563995d3888c296a94/external-address/structs";
...
export class GovernanceDataSource implements StructClass {
    ...
    static reified(): GovernanceDataSourceReified {
        return {
            ...
            fromSuiObjectData: (content: SuiObjectData) => GovernanceDataSource.fromSuiObjectData(content),
