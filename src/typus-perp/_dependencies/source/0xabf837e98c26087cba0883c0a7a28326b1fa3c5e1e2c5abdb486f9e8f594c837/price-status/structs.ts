...
export class PriceStatus implements StructClass {
    ...
    private constructor(typeArgs: [], fields: PriceStatusFields) {
        this.$fullTypeName = composeSuiType(PriceStatus.$typeName, ...typeArgs) as `${typeof PKG_V1}::price_status::PriceStatus`;
    ...
    static reified(): PriceStatusReified {
        return {
            ...
            fullTypeName: composeSuiType(PriceStatus.$typeName, ...[]) as `${typeof PKG_V1}::price_status::PriceStatus`,
            typeArgs: [] as [],
