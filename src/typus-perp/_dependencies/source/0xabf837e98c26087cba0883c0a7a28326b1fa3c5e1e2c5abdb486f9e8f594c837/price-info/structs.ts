...
export class PriceInfo implements StructClass {
    ...
    private constructor(typeArgs: [], fields: PriceInfoFields) {
        this.$fullTypeName = composeSuiType(PriceInfo.$typeName, ...typeArgs) as `${typeof PKG_V1}::price_info::PriceInfo`;
    ...
    static reified(): PriceInfoReified {
        return {
            ...
            fullTypeName: composeSuiType(PriceInfo.$typeName, ...[]) as `${typeof PKG_V1}::price_info::PriceInfo`,
            typeArgs: [] as [],
...
export class PriceInfoObject implements StructClass {
    ...
    private constructor(typeArgs: [], fields: PriceInfoObjectFields) {
        this.$fullTypeName = composeSuiType(PriceInfoObject.$typeName, ...typeArgs) as `${typeof PKG_V1}::price_info::PriceInfoObject`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): PriceInfoObjectReified {
        return {
            ...
            fullTypeName: composeSuiType(PriceInfoObject.$typeName, ...[]) as `${typeof PKG_V1}::price_info::PriceInfoObject`,
            typeArgs: [] as [],
