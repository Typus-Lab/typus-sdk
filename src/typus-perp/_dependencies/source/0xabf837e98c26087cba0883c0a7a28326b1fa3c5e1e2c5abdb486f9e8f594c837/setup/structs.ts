...
export class DeployerCap implements StructClass {
    ...
    private constructor(typeArgs: [], fields: DeployerCapFields) {
        this.$fullTypeName = composeSuiType(DeployerCap.$typeName, ...typeArgs) as `${typeof PKG_V1}::setup::DeployerCap`;
    ...
    static reified(): DeployerCapReified {
        return {
            ...
            fullTypeName: composeSuiType(DeployerCap.$typeName, ...[]) as `${typeof PKG_V1}::setup::DeployerCap`,
            typeArgs: [] as [],
