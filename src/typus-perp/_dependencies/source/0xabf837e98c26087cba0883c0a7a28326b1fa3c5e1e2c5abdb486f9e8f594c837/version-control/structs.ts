...
export class V__0_1_1 implements StructClass {
    ...
    private constructor(typeArgs: [], fields: V__0_1_1Fields) {
        this.$fullTypeName = composeSuiType(V__0_1_1.$typeName, ...typeArgs) as `${typeof PKG_V1}::version_control::V__0_1_1`;
    ...
    static reified(): V__0_1_1Reified {
        return {
            ...
            fullTypeName: composeSuiType(V__0_1_1.$typeName, ...[]) as `${typeof PKG_V1}::version_control::V__0_1_1`,
            typeArgs: [] as [],
...
export class V__0_1_2 implements StructClass {
    ...
    private constructor(typeArgs: [], fields: V__0_1_2Fields) {
        this.$fullTypeName = composeSuiType(V__0_1_2.$typeName, ...typeArgs) as `${typeof PKG_V1}::version_control::V__0_1_2`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): V__0_1_2Reified {
        return {
            ...
            fullTypeName: composeSuiType(V__0_1_2.$typeName, ...[]) as `${typeof PKG_V1}::version_control::V__0_1_2`,
            typeArgs: [] as [],
...
export class V__DUMMY implements StructClass {
    ...
    private constructor(typeArgs: [], fields: V__DUMMYFields) {
        this.$fullTypeName = composeSuiType(V__DUMMY.$typeName, ...typeArgs) as `${typeof PKG_V1}::version_control::V__DUMMY`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): V__DUMMYReified {
        return {
            ...
            fullTypeName: composeSuiType(V__DUMMY.$typeName, ...[]) as `${typeof PKG_V1}::version_control::V__DUMMY`,
            typeArgs: [] as [],
