...
export class ContractUpgraded implements StructClass {
    ...
    static reified(): ContractUpgradedReified {
        return {
            ...
            fullTypeName: composeSuiType(ContractUpgraded.$typeName, ...[]) as `${typeof PKG_V1}::contract_upgrade::ContractUpgraded`,
            typeArgs: [] as [],
...
export class UpgradeContract implements StructClass {
    ...
    static reified(): UpgradeContractReified {
        return {
            ...
            fullTypeName: composeSuiType(UpgradeContract.$typeName, ...[]) as `${typeof PKG_V1}::contract_upgrade::UpgradeContract`,
            typeArgs: [] as [],
