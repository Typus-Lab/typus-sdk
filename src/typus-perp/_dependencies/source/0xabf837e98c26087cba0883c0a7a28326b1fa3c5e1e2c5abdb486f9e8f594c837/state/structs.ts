...
import { ConsumedVAAs } from "../../0xf47329f4344f3bf0f8e436e2f7b485466cff300f12a166563995d3888c296a94/consumed-vaas/structs";
...
export class CurrentDigest implements StructClass {
    ...
    private constructor(typeArgs: [], fields: CurrentDigestFields) {
        this.$fullTypeName = composeSuiType(CurrentDigest.$typeName, ...typeArgs) as `${typeof PKG_V1}::state::CurrentDigest`;
    ...
    static reified(): CurrentDigestReified {
        return {
            ...
            fullTypeName: composeSuiType(CurrentDigest.$typeName, ...[]) as `${typeof PKG_V1}::state::CurrentDigest`,
            typeArgs: [] as [],
...
export class LatestOnly implements StructClass {
    ...
    private constructor(typeArgs: [], fields: LatestOnlyFields) {
        this.$fullTypeName = composeSuiType(LatestOnly.$typeName, ...typeArgs) as `${typeof PKG_V1}::state::LatestOnly`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): LatestOnlyReified {
        return {
            ...
            fullTypeName: composeSuiType(LatestOnly.$typeName, ...[]) as `${typeof PKG_V1}::state::LatestOnly`,
            typeArgs: [] as [],
...
export class State implements StructClass {
    ...
    private constructor(typeArgs: [], fields: StateFields) {
        this.$fullTypeName = composeSuiType(State.$typeName, ...typeArgs) as `${typeof PKG_V1}::state::State`;
        this.$typeArgs = typeArgs;
    ...
    static fromFields(fields: Record<string, any>): State {
        return State.reified().new({
            ...
            lastExecutedGovernanceSequence: decodeFromFields("u64", fields.last_executed_governance_sequence),
    ...
    static fromFieldsWithTypes(item: FieldsWithTypes): State {
        ...
        return State.reified().new({
            ...
            governanceDataSource: decodeFromFieldsWithTypes(DataSource.reified(), item.fields.governance_data_source),
            ...
            lastExecutedGovernanceSequence: decodeFromFieldsWithTypes("u64", item.fields.last_executed_governance_sequence),
    ...
    static fromJSONField(field: any): State {
        return State.reified().new({
            ...
            lastExecutedGovernanceSequence: decodeFromJSONField("u64", field.lastExecutedGovernanceSequence),
