...
export class BatchPriceAttestation implements StructClass {
    ...
    static reified(): BatchPriceAttestationReified {
        return {
            ...
            fromSuiObjectData: (content: SuiObjectData) => BatchPriceAttestation.fromSuiObjectData(content),
...
export class Header implements StructClass {
    ...
    private constructor(typeArgs: [], fields: HeaderFields) {
        this.$fullTypeName = composeSuiType(Header.$typeName, ...typeArgs) as `${typeof PKG_V1}::batch_price_attestation::Header`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): HeaderReified {
        return {
            ...
            fullTypeName: composeSuiType(Header.$typeName, ...[]) as `${typeof PKG_V1}::batch_price_attestation::Header`,
            typeArgs: [] as [],
