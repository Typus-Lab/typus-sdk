...
export class DataSource implements StructClass {
    ...
    private constructor(typeArgs: [], fields: DataSourceFields) {
        this.$fullTypeName = composeSuiType(DataSource.$typeName, ...typeArgs) as `${typeof PKG_V1}::data_source::DataSource`;
    ...
    static reified(): DataSourceReified {
        return {
            ...
            fullTypeName: composeSuiType(DataSource.$typeName, ...[]) as `${typeof PKG_V1}::data_source::DataSource`,
            typeArgs: [] as [],
