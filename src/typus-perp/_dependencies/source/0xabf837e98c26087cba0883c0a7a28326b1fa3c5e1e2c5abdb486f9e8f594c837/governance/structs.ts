...
import { Bytes32 } from "../../0xf47329f4344f3bf0f8e436e2f7b485466cff300f12a166563995d3888c296a94/bytes32/structs";
...
export class WormholeVAAVerificationReceipt implements StructClass {
    ...
    static reified(): WormholeVAAVerificationReceiptReified {
        return {
            ...
            fromSuiObjectData: (content: SuiObjectData) => WormholeVAAVerificationReceipt.fromSuiObjectData(content),
