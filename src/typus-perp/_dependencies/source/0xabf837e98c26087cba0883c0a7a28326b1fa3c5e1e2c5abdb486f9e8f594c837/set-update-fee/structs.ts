...
export class UpdateFee implements StructClass {
    ...
    private constructor(typeArgs: [], fields: UpdateFeeFields) {
        this.$fullTypeName = composeSuiType(UpdateFee.$typeName, ...typeArgs) as `${typeof PKG_V1}::set_update_fee::UpdateFee`;
    ...
    static reified(): UpdateFeeReified {
        return {
            ...
            fullTypeName: composeSuiType(UpdateFee.$typeName, ...[]) as `${typeof PKG_V1}::set_update_fee::UpdateFee`,
            typeArgs: [] as [],
