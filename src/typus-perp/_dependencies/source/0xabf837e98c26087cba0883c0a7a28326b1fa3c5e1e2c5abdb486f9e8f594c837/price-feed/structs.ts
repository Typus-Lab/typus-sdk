...
export class PriceFeed implements StructClass {
    ...
    private constructor(typeArgs: [], fields: PriceFeedFields) {
        this.$fullTypeName = composeSuiType(PriceFeed.$typeName, ...typeArgs) as `${typeof PKG_V1}::price_feed::PriceFeed`;
    ...
    static reified(): PriceFeedReified {
        return {
            ...
            fullTypeName: composeSuiType(PriceFeed.$typeName, ...[]) as `${typeof PKG_V1}::price_feed::PriceFeed`,
            typeArgs: [] as [],
