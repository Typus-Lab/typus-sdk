...
function isVersion(type) {
    ...
    return type === "0x4bcf9eade4480bcb9fcd3139ec8d22afda34b25af06092904fcccb06e1b8043c::admin::Version";
}
var Version = /** @class */ (function () {
    ...
    Object.defineProperty(Version, "bcs", {
        get: function () {
            return bcs_1.bcs.struct("Version", {
                ...
                authority: structs_3.VecSet.bcs(bcs_1.bcs.bytes(32).transform({ input: function (val) { return (0, bcs_1.fromHEX)(val); }, output: function (val) { return (0, bcs_1.toHEX)(val); } })),
    ...
    Version.$typeName = "0x4bcf9eade4480bcb9fcd3139ec8d22afda34b25af06092904fcccb06e1b8043c::admin::Version";
...
function isManagerCap(type) {
    type = (0, util_1.compressSuiType)(type);
    return type === "0x4bcf9eade4480bcb9fcd3139ec8d22afda34b25af06092904fcccb06e1b8043c::admin::ManagerCap";
}
var ManagerCap = /** @class */ (function () {
    ...
    ManagerCap.$typeName = "0x4bcf9eade4480bcb9fcd3139ec8d22afda34b25af06092904fcccb06e1b8043c::admin::ManagerCap";
...
function isFeeInfo(type) {
    type = (0, util_1.compressSuiType)(type);
    return type === "0x4bcf9eade4480bcb9fcd3139ec8d22afda34b25af06092904fcccb06e1b8043c::admin::FeeInfo";
}
var FeeInfo = /** @class */ (function () {
    ...
    FeeInfo.$typeName = "0x4bcf9eade4480bcb9fcd3139ec8d22afda34b25af06092904fcccb06e1b8043c::admin::FeeInfo";
...
function isFeePool(type) {
    type = (0, util_1.compressSuiType)(type);
    return type === "0x4bcf9eade4480bcb9fcd3139ec8d22afda34b25af06092904fcccb06e1b8043c::admin::FeePool";
}
var FeePool = /** @class */ (function () {
    ...
    FeePool.prototype.toJSONField = function () {
        return {
            id: this.id,
            feeInfos: (0, reified_1.fieldToJSON)("vector<0x4bcf9eade4480bcb9fcd3139ec8d22afda34b25af06092904fcccb06e1b8043c::admin::FeeInfo>", this.feeInfos),
        };
    };
    ...
    FeePool.$typeName = "0x4bcf9eade4480bcb9fcd3139ec8d22afda34b25af06092904fcccb06e1b8043c::admin::FeePool";
...
function isSendFeeEvent(type) {
    type = (0, util_1.compressSuiType)(type);
    return type === "0x4bcf9eade4480bcb9fcd3139ec8d22afda34b25af06092904fcccb06e1b8043c::admin::SendFeeEvent";
}
var SendFeeEvent = /** @class */ (function () {
    ...
    SendFeeEvent.$typeName = "0x4bcf9eade4480bcb9fcd3139ec8d22afda34b25af06092904fcccb06e1b8043c::admin::SendFeeEvent";
