...
/* ============================== Rule =============================== */
function isRule(type) { type = (0, util_1.compressSuiType)(type); return type === "0xbd8fc1947cf119350184107a3087e2dc27efefa0dd82e25a1f699069fe81a585::kiosk_lock_rule::Rule"; }
var Rule = /** @class */ (function () {
    ...
    Rule.$typeName = "0xbd8fc1947cf119350184107a3087e2dc27efefa0dd82e25a1f699069fe81a585::kiosk_lock_rule::Rule";
    Rule.$numTypeParams = 0;
    return Rule;
}());
exports.Rule = Rule;
/* ============================== Config =============================== */
function isConfig(type) { type = (0, util_1.compressSuiType)(type); return type === "0xbd8fc1947cf119350184107a3087e2dc27efefa0dd82e25a1f699069fe81a585::kiosk_lock_rule::Config"; }
var Config = /** @class */ (function () {
    ...
    ;
    Config.fromFields = function (fields) { return Config.reified().new({ dummyField: (0, reified_1.decodeFromFields)("bool", fields.dummy_field) }); };
    Config.fromFieldsWithTypes = function (item) {
        if (!isConfig(item.type)) {
            throw new Error("not a Config type");
        }
        return Config.reified().new({ dummyField: (0, reified_1.decodeFromFieldsWithTypes)("bool", item.fields.dummy_field) });
    };
    ...
    Config.fromJSONField = function (field) { return Config.reified().new({ dummyField: (0, reified_1.decodeFromJSONField)("bool", field.dummyField) }); };
    ...
    Config.$typeName = "0xbd8fc1947cf119350184107a3087e2dc27efefa0dd82e25a1f699069fe81a585::kiosk_lock_rule::Config";
