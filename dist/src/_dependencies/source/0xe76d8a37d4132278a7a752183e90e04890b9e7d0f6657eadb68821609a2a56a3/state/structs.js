...
exports.State = exports.LatestOnly = exports.CurrentDigest = void 0;
exports.isCurrentDigest = isCurrentDigest;
...
var structs_3 = require("../../0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e/consumed-vaas/structs");
var structs_4 = require("../data-source/structs");
var bcs_1 = require("@mysten/bcs");
/* ============================== CurrentDigest =============================== */
function isCurrentDigest(type) { type = (0, util_1.compressSuiType)(type); return type === "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::state::CurrentDigest"; }
var CurrentDigest = /** @class */ (function () {
    function CurrentDigest(typeArgs, fields) {
        this.$typeName = CurrentDigest.$typeName;
        this.$fullTypeName = util_1.composeSuiType.apply(void 0, __spreadArray([CurrentDigest.$typeName], __read(typeArgs), false));
        this.$typeArgs = typeArgs;
        this.dummyField = fields.dummyField;
    }
    CurrentDigest.reified = function () {
        var _this = this;
        return { typeName: CurrentDigest.$typeName, fullTypeName: util_1.composeSuiType.apply(void 0, __spreadArray([CurrentDigest.$typeName], [], false)), typeArgs: [], reifiedTypeArgs: [], fromFields: function (fields) { return CurrentDigest.fromFields(fields); }, fromFieldsWithTypes: function (item) { return CurrentDigest.fromFieldsWithTypes(item); }, fromBcs: function (data) { return CurrentDigest.fromBcs(data); }, bcs: CurrentDigest.bcs, fromJSONField: function (field) { return CurrentDigest.fromJSONField(field); }, fromJSON: function (json) { return CurrentDigest.fromJSON(json); }, fromSuiParsedData: function (content) { return CurrentDigest.fromSuiParsedData(content); }, fetch: function (client, id) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                return [2 /*return*/, CurrentDigest.fetch(client, id)];
            }); }); }, new: function (fields) { return new CurrentDigest([], fields); }, kind: "StructClassReified", };
    };
    Object.defineProperty(CurrentDigest, "r", {
        get: function () { return CurrentDigest.reified(); },
        enumerable: false,
        configurable: true
    });
    CurrentDigest.phantom = function () { return (0, reified_1.phantom)(CurrentDigest.reified()); };
    Object.defineProperty(CurrentDigest, "p", {
        get: function () { return CurrentDigest.phantom(); },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(CurrentDigest, "bcs", {
        get: function () {
            return bcs_1.bcs.struct("CurrentDigest", {
    ...
    ;
    CurrentDigest.fromFields = function (fields) { return CurrentDigest.reified().new({ dummyField: (0, reified_1.decodeFromFields)("bool", fields.dummy_field) }); };
    CurrentDigest.fromFieldsWithTypes = function (item) {
        if (!isCurrentDigest(item.type)) {
            throw new Error("not a CurrentDigest type");
        }
        return CurrentDigest.reified().new({ dummyField: (0, reified_1.decodeFromFieldsWithTypes)("bool", item.fields.dummy_field) });
    };
    CurrentDigest.fromBcs = function (data) { return CurrentDigest.fromFields(CurrentDigest.bcs.parse(data)); };
    CurrentDigest.prototype.toJSONField = function () {
        return {
            dummyField: this.dummyField,
        };
    };
    CurrentDigest.prototype.toJSON = function () { return __assign({ $typeName: this.$typeName, $typeArgs: this.$typeArgs }, this.toJSONField()); };
    CurrentDigest.fromJSONField = function (field) { return CurrentDigest.reified().new({ dummyField: (0, reified_1.decodeFromJSONField)("bool", field.dummyField) }); };
    CurrentDigest.fromJSON = function (json) {
    ...
    CurrentDigest.fromSuiParsedData = function (content) { if (content.dataType !== "moveObject") {
        throw new Error("not an object");
    } if (!isCurrentDigest(content.type)) {
        throw new Error("object at ".concat(content.fields.id, " is not a CurrentDigest object"));
    } return CurrentDigest.fromFieldsWithTypes(content); };
    CurrentDigest.fetch = function (client, id) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        res = _c.sent();
                        if (res.error) {
                            throw new Error("error fetching CurrentDigest object at id ".concat(id, ": ").concat(res.error.code));
                        }
                        if (((_b = (_a = res.data) === null || _a === void 0 ? void 0 : _a.bcs) === null || _b === void 0 ? void 0 : _b.dataType) !== "moveObject" || !isCurrentDigest(res.data.bcs.type)) {
                            throw new Error("object at id ".concat(id, " is not a CurrentDigest object"));
                        }
                        return [2 /*return*/, CurrentDigest.fromBcs((0, bcs_1.fromB64)(res.data.bcs.bcsBytes))];
                }
            });
        });
    };
    CurrentDigest.$typeName = "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::state::CurrentDigest";
    CurrentDigest.$numTypeParams = 0;
    return CurrentDigest;
}());
exports.CurrentDigest = CurrentDigest;
/* ============================== LatestOnly =============================== */
function isLatestOnly(type) { type = (0, util_1.compressSuiType)(type); return type === "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::state::LatestOnly"; }
var LatestOnly = /** @class */ (function () {
    ...
    LatestOnly.$typeName = "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::state::LatestOnly";
    LatestOnly.$numTypeParams = 0;
    return LatestOnly;
}());
exports.LatestOnly = LatestOnly;
/* ============================== State =============================== */
function isState(type) { type = (0, util_1.compressSuiType)(type); return type === "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::state::State"; }
var State = /** @class */ (function () {
    ...
    Object.defineProperty(State, "bcs", {
        get: function () {
            return bcs_1.bcs.struct("State", {
                id: structs_1.UID.bcs, governance_data_source: structs_4.DataSource.bcs, stale_price_threshold: bcs_1.bcs.u64(), base_update_fee: bcs_1.bcs.u64(), fee_recipient_address: bcs_1.bcs.bytes(32).transform({ input: function (val) { return (0, bcs_1.fromHEX)(val); }, output: function (val) { return (0, bcs_1.toHEX)(val); }, }), last_executed_governance_sequence: bcs_1.bcs.u64(), consumed_vaas: structs_3.ConsumedVAAs.bcs, upgrade_cap: structs_2.UpgradeCap.bcs
            });
        },
        enumerable: false,
        configurable: true
    ...
    ;
    State.fromFields = function (fields) { return State.reified().new({ id: (0, reified_1.decodeFromFields)(structs_1.UID.reified(), fields.id), governanceDataSource: (0, reified_1.decodeFromFields)(structs_4.DataSource.reified(), fields.governance_data_source), stalePriceThreshold: (0, reified_1.decodeFromFields)("u64", fields.stale_price_threshold), baseUpdateFee: (0, reified_1.decodeFromFields)("u64", fields.base_update_fee), feeRecipientAddress: (0, reified_1.decodeFromFields)("address", fields.fee_recipient_address), lastExecutedGovernanceSequence: (0, reified_1.decodeFromFields)("u64", fields.last_executed_governance_sequence), consumedVaas: (0, reified_1.decodeFromFields)(structs_3.ConsumedVAAs.reified(), fields.consumed_vaas), upgradeCap: (0, reified_1.decodeFromFields)(structs_2.UpgradeCap.reified(), fields.upgrade_cap) }); };
    State.fromFieldsWithTypes = function (item) {
        if (!isState(item.type)) {
            throw new Error("not a State type");
        }
        return State.reified().new({ id: (0, reified_1.decodeFromFieldsWithTypes)(structs_1.UID.reified(), item.fields.id), governanceDataSource: (0, reified_1.decodeFromFieldsWithTypes)(structs_4.DataSource.reified(), item.fields.governance_data_source), stalePriceThreshold: (0, reified_1.decodeFromFieldsWithTypes)("u64", item.fields.stale_price_threshold), baseUpdateFee: (0, reified_1.decodeFromFieldsWithTypes)("u64", item.fields.base_update_fee), feeRecipientAddress: (0, reified_1.decodeFromFieldsWithTypes)("address", item.fields.fee_recipient_address), lastExecutedGovernanceSequence: (0, reified_1.decodeFromFieldsWithTypes)("u64", item.fields.last_executed_governance_sequence), consumedVaas: (0, reified_1.decodeFromFieldsWithTypes)(structs_3.ConsumedVAAs.reified(), item.fields.consumed_vaas), upgradeCap: (0, reified_1.decodeFromFieldsWithTypes)(structs_2.UpgradeCap.reified(), item.fields.upgrade_cap) });
    };
    ...
    State.fromJSONField = function (field) { return State.reified().new({ id: (0, reified_1.decodeFromJSONField)(structs_1.UID.reified(), field.id), governanceDataSource: (0, reified_1.decodeFromJSONField)(structs_4.DataSource.reified(), field.governanceDataSource), stalePriceThreshold: (0, reified_1.decodeFromJSONField)("u64", field.stalePriceThreshold), baseUpdateFee: (0, reified_1.decodeFromJSONField)("u64", field.baseUpdateFee), feeRecipientAddress: (0, reified_1.decodeFromJSONField)("address", field.feeRecipientAddress), lastExecutedGovernanceSequence: (0, reified_1.decodeFromJSONField)("u64", field.lastExecutedGovernanceSequence), consumedVaas: (0, reified_1.decodeFromJSONField)(structs_3.ConsumedVAAs.reified(), field.consumedVaas), upgradeCap: (0, reified_1.decodeFromJSONField)(structs_2.UpgradeCap.reified(), field.upgradeCap) }); };
    ...
    State.$typeName = "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::state::State";
