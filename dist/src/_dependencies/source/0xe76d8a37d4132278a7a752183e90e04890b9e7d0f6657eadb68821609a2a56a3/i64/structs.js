...
/* ============================== I64 =============================== */
function isI64(type) { type = (0, util_1.compressSuiType)(type); return type === "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::i64::I64"; }
var I64 = /** @class */ (function () {
    ...
    Object.defineProperty(I64, "bcs", {
        get: function () {
            return bcs_1.bcs.struct("I64", {
                negative: bcs_1.bcs.bool(), magnitude: bcs_1.bcs.u64()
            });
        },
        enumerable: false,
        configurable: true
    ...
    ;
    I64.fromFields = function (fields) { return I64.reified().new({ negative: (0, reified_1.decodeFromFields)("bool", fields.negative), magnitude: (0, reified_1.decodeFromFields)("u64", fields.magnitude) }); };
    I64.fromFieldsWithTypes = function (item) {
        if (!isI64(item.type)) {
            throw new Error("not a I64 type");
        }
        return I64.reified().new({ negative: (0, reified_1.decodeFromFieldsWithTypes)("bool", item.fields.negative), magnitude: (0, reified_1.decodeFromFieldsWithTypes)("u64", item.fields.magnitude) });
    };
    ...
    I64.fromJSONField = function (field) { return I64.reified().new({ negative: (0, reified_1.decodeFromJSONField)("bool", field.negative), magnitude: (0, reified_1.decodeFromJSONField)("u64", field.magnitude) }); };
    ...
    I64.$typeName = "0xe76d8a37d4132278a7a752183e90e04890b9e7d0f6657eadb68821609a2a56a3::i64::I64";
    I64.$numTypeParams = 0;
    return I64;
}());
exports.I64 = I64;
