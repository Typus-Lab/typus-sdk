...
exports.SetFee = exports.GovernanceWitness = void 0;
exports.isGovernanceWitness = isGovernanceWitness;
exports.isSetFee = isSetFee;
var reified_1 = require("../../../../_framework/reified");
var util_1 = require("../../../../_framework/util");
var bcs_1 = require("@mysten/bcs");
/* ============================== GovernanceWitness =============================== */
function isGovernanceWitness(type) { type = (0, util_1.compressSuiType)(type); return type === "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::set_fee::GovernanceWitness"; }
var GovernanceWitness = /** @class */ (function () {
    ...
    GovernanceWitness.$typeName = "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::set_fee::GovernanceWitness";
    GovernanceWitness.$numTypeParams = 0;
    return GovernanceWitness;
}());
exports.GovernanceWitness = GovernanceWitness;
/* ============================== SetFee =============================== */
function isSetFee(type) { type = (0, util_1.compressSuiType)(type); return type === "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::set_fee::SetFee"; }
var SetFee = /** @class */ (function () {
    function SetFee(typeArgs, fields) {
        this.$typeName = SetFee.$typeName;
        this.$fullTypeName = util_1.composeSuiType.apply(void 0, __spreadArray([SetFee.$typeName], __read(typeArgs), false));
        this.$typeArgs = typeArgs;
        this.amount = fields.amount;
    }
    SetFee.reified = function () {
        var _this = this;
        return { typeName: SetFee.$typeName, fullTypeName: util_1.composeSuiType.apply(void 0, __spreadArray([SetFee.$typeName], [], false)), typeArgs: [], reifiedTypeArgs: [], fromFields: function (fields) { return SetFee.fromFields(fields); }, fromFieldsWithTypes: function (item) { return SetFee.fromFieldsWithTypes(item); }, fromBcs: function (data) { return SetFee.fromBcs(data); }, bcs: SetFee.bcs, fromJSONField: function (field) { return SetFee.fromJSONField(field); }, fromJSON: function (json) { return SetFee.fromJSON(json); }, fromSuiParsedData: function (content) { return SetFee.fromSuiParsedData(content); }, fetch: function (client, id) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                return [2 /*return*/, SetFee.fetch(client, id)];
            }); }); }, new: function (fields) { return new SetFee([], fields); }, kind: "StructClassReified", };
    };
    Object.defineProperty(SetFee, "r", {
        get: function () { return SetFee.reified(); },
        enumerable: false,
        configurable: true
    });
    SetFee.phantom = function () { return (0, reified_1.phantom)(SetFee.reified()); };
    Object.defineProperty(SetFee, "p", {
        get: function () { return SetFee.phantom(); },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SetFee, "bcs", {
        get: function () {
            return bcs_1.bcs.struct("SetFee", {
    ...
    ;
    SetFee.fromFields = function (fields) { return SetFee.reified().new({ amount: (0, reified_1.decodeFromFields)("u64", fields.amount) }); };
    SetFee.fromFieldsWithTypes = function (item) {
        if (!isSetFee(item.type)) {
            throw new Error("not a SetFee type");
        }
        return SetFee.reified().new({ amount: (0, reified_1.decodeFromFieldsWithTypes)("u64", item.fields.amount) });
    };
    SetFee.fromBcs = function (data) { return SetFee.fromFields(SetFee.bcs.parse(data)); };
    SetFee.prototype.toJSONField = function () {
        return {
            amount: this.amount.toString(),
        };
    };
    SetFee.prototype.toJSON = function () { return __assign({ $typeName: this.$typeName, $typeArgs: this.$typeArgs }, this.toJSONField()); };
    SetFee.fromJSONField = function (field) { return SetFee.reified().new({ amount: (0, reified_1.decodeFromJSONField)("u64", field.amount) }); };
    SetFee.fromJSON = function (json) {
    ...
    SetFee.fromSuiParsedData = function (content) { if (content.dataType !== "moveObject") {
        throw new Error("not an object");
    } if (!isSetFee(content.type)) {
        throw new Error("object at ".concat(content.fields.id, " is not a SetFee object"));
    } return SetFee.fromFieldsWithTypes(content); };
    SetFee.fetch = function (client, id) {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        res = _c.sent();
                        if (res.error) {
                            throw new Error("error fetching SetFee object at id ".concat(id, ": ").concat(res.error.code));
                        }
                        if (((_b = (_a = res.data) === null || _a === void 0 ? void 0 : _a.bcs) === null || _b === void 0 ? void 0 : _b.dataType) !== "moveObject" || !isSetFee(res.data.bcs.type)) {
                            throw new Error("object at id ".concat(id, " is not a SetFee object"));
                        }
                        return [2 /*return*/, SetFee.fromBcs((0, bcs_1.fromB64)(res.data.bcs.bcsBytes))];
                }
            });
        });
    };
    SetFee.$typeName = "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::set_fee::SetFee";
    SetFee.$numTypeParams = 0;
    return SetFee;
}());
