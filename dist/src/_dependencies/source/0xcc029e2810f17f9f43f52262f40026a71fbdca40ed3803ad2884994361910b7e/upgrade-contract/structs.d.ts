...
export declare class ContractUpgraded implements StructClass {
    ...
    readonly $typeName = "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::upgrade_contract::ContractUpgraded";
    ...
    static get p(): PhantomReified<"0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::upgrade_contract::ContractUpgraded">;
...
export declare class GovernanceWitness implements StructClass {
    ...
    static readonly $numTypeParams = 0;
    readonly $typeName = "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::upgrade_contract::GovernanceWitness";
    ...
    static get p(): PhantomReified<"0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::upgrade_contract::GovernanceWitness">;
    static get bcs(): import("@mysten/bcs").BcsType<{
        dummy_field: boolean;
    }, {
        dummy_field: boolean;
...
export declare class UpgradeContract implements StructClass {
    ...
    static readonly $numTypeParams = 0;
    readonly $typeName = "0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::upgrade_contract::UpgradeContract";
    ...
    static get p(): PhantomReified<"0xcc029e2810f17f9f43f52262f40026a71fbdca40ed3803ad2884994361910b7e::upgrade_contract::UpgradeContract">;
    static get bcs(): import("@mysten/bcs").BcsType<{
        digest: {
            data: number[];
        };
